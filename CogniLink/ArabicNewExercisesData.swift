...
struct ArabicNewExercisesData {
    ...
    private static let exercise6 = Exercise(
        ...
        difficulty: .medium,
        items: [
            ExerciseItem(prompt: "ذهبت ماريا إلى البقالة لشراء الحليب والخبز. ونسيت محفظتها على طاولة المطبخ. ماذا تركت ماريا في المنزل؟", options: ["محفظتها", "مفاتيحها", "قائمة التسوق", "هاتفها"], correctAnswer: "محفظتها", explanation: "تذكر القصة أنها نسيت محفظتها على طاولة المطبخ."),
            ExerciseItem(prompt: "استيقظ توماس باكراً يوم السبت للذهاب للصيد. اصطاد سمكة تونة كبيرة لكنه اضطر لإعادتها للماء لأنها كانت صغيرة جداً. ما نوع السمكة التي اصطادها توماس؟", options: ["سمكة تونة", "سمكة سالمون", "سمكة هامور", "سمكة قرش"], correctAnswer: "سمكة تونة", explanation: "تذكر القصة أنه اصطاد سمكة تونة كبيرة."),
            ExerciseItem(prompt: "أوقف آرثر سيارته الزرقاء تحت شجرة بلوط ظليلة. وعندما عاد، رأى أن السيارة مغطاة بأوراق شجر صفراء. ما لون سيارة آرثر؟", options: ["أزرق", "أصفر", "أحمر", "أخضر"], correctAnswer: "أزرق", explanation: "تذكر القصة أن آرثر أوقف سيارته الزرقاء."),
            ExerciseItem(prompt: "خبزت ليندا كعكة شوكولاتة لحفلة عيد ميلاد ابنتها. وضعت عشر شموع حمراء على الكعكة. كم شمعة وضعت ليندا على الكعكة؟", options: ["عشرة", "خمسة", "ثمانية", "اثنتا عشرة"], correctAnswer: "عشرة", explanation: "تذكر القصة أنها وضعت عشر شموع حمراء على الكعكة."),
            ExerciseItem(prompt: "ذهب روبرت إلى مكتب البريد لإرسال طرد لأخيه في شيكاغو. وأخبره الموظف أنه سيصل يوم الثلاثاء. أين يعيش شقيق روبرت؟", options: ["شيكاغو", "نيويورك", "بوسطن", "ميامي"], correctAnswer: "شيكاغو", explanation: "تذكر القصة أنه أرسل طرداً لأخيه في شيكاغو."),
            ExerciseItem(prompt: "اشترت سارة زوجاً جديداً من أحذية الجري بالأمس. لونها أخضر فاتح مع خطوط بيضاء. ما لون حذاء الجري الجديد لسارة؟", options: ["أخضر فاتح", "أزرق", "أحمر", "أسود"], correctAnswer: "أخضر فاتح", explanation: "تذكر القصة أن لون الحذاء أخضر فاتح مع خطوط بيضاء."),
            ExerciseItem(prompt: "كان جيمس يمشي في الحديقة عندما بدأت تمطر. فتح مظلته الصفراء ليظل جافاً. ما لون المظلة التي استخدمها جيمس؟", options: ["أصفر", "أحمر", "أزرق", "أسود"], correctAnswer: "أصفر", explanation: "تذكر القصة أنه فتح مظلته الصفراء."),
            ExerciseItem(prompt: "كان المخبز المحلي مغلقاً يوم الاثنين لإجراء بعض الإصلاحات. وخططوا لإعادة الفتح صباح الثلاثاء في الساعة السادسة. في أي يوم كان المخبز مغلقاً؟", options: ["الاثنين", "الثلاثاء", "الأربعاء", "الأحد"], correctAnswer: "الاثنين", explanation: "تذكر القصة أن المخبز كان مغلقاً يوم الاثنين."),
            ExerciseItem(prompt: "اتصلت آنا بسباك لأن حوض المطبخ كان يسرب الماء. وصل السباك خلال ساعة وأصلح الأنبوب. لماذا اتصلت آنا بسباك؟", options: ["حوض المطبخ يسرب الماء", "الموقد كان معطلاً", "الضوء كان مطفأً", "الباب كان مغلقاً"], correctAnswer: "حوض المطبخ يسرب الماء", explanation: "تذكر القصة أنها اتصلت بسباك لأن حوض المطبخ كان يسرب الماء."),
            ExerciseItem(prompt: "أخذ ديفيد كلبه مكس في نزهة حول الحي. رأى مكس سنجاباً ونبح عليه بصوت عالٍ. ما اسم كلب ديفيد؟", options: ["مكس", "بودي", "تشارلي", "روكي"], correctAnswer: "مكس", explanation: "تذكر القصة أن اسم كلب ديفيد هو مكس."),
            ExerciseItem(prompt: "كانت هيلين تحضر حساء الخضار لتناول العشاء. وأدركت أن الجزر قد نفد منها، فاستخدمت البطاطس بدلاً منه. ما هو المكون الذي نفد من هيلين؟", options: ["الجزر", "البطاطس", "البصل", "الكرفس"], correctAnswer: "الجزر", explanation: "تذكر القصة أنها أدركت أن الجزر قد نفد منها."),
            ExerciseItem(prompt: "طلب بيتر بيتزا ببروني وزجاجة صودا لتناول الغداء. وكان التكلفة الإجمالية خمسة عشر دولاراً. كم كلف غداء بيتر؟", options: ["خمسة عشر دولاراً", "عشرة دولارات", "عشرون دولاراً", "اثنا عشر دولاراً"], correctAnswer: "خمسة عشر دولاراً", explanation: "تذكر القصة أن التكلفة الإجمالية كانت خمسة عشر دولاراً."),
            ExerciseItem(prompt: "ذهبت أليس إلى المكتبة لاستعارة كتاب عن البستنة. واستعارت أيضاً قرص DVD عن التاريخ. ما هو موضوع الكتاب الذي استعارته أليس؟", options: ["البستنة", "التاريخ", "الطبخ", "السفر"], correctAnswer: "البستنة", explanation: "تذكر القصة أنها استعارت كتاباً عن البستنة."),
            ExerciseItem(prompt: "استقل جورج قطار الصباح إلى المدينة لإجراء مقابلة عمل. وتأخر قطاره لمدة خمس عشرة دقيقة بسبب صيانة السكك الحديدية. لماذا تأخر القطار؟", options: ["صيانة السكك الحديدية", "عاصفة قوية", "انقطاع الكهرباء", "نقص الموظفين"], correctAnswer: "صيانة السكك الحديدية", explanation: "تذكر القصة أن القطار تأخر بسبب صيانة السكك الحديدية."),
            ExerciseItem(prompt: "ذهبت نانسي إلى مركز الحدائق لشراء زهور الورد الأحمر. كانت قد نفدت، فاشترت زهور القرنفل الوردي بدلاً من ذلك. ما هي الزهرة التي اشترتها نانسي في النهاية؟", options: ["القرنفل الوردي", "الورد الأحمر", "الزنابق الصفراء", "الزنابق البيضاء"], correctAnswer: "القرنفل الوردي", explanation: "تذكر القصة أنها اشترت زهور القرنفل الوردي في النهاية.")
        ]
    )
