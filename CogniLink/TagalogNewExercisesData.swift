...
struct TagalogNewExercisesData {
    ...
    private static let exercise6 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "Anong uri ng isda ang nahuli ni Tomas?", options: ["Trout", "Salmon", "Sapsap", "Hito"], correctAnswer: "Trout", explanation: "Nabanggit sa kuwento na nakahuli siya ng malaking trout.", passage: "Maagang gumising si Tomas noong Sabado upang mangisda. Nakahuli siya ng malaking isdang trout ngunit kailangan niya itong ibalik dahil masyadong maliit."),
            ExerciseItem(prompt: "Ano ang kulay ng kotse ni Arthur?", options: ["Asul", "Dilaw", "Pula", "Berde"], correctAnswer: "Asul", explanation: "Nabanggit sa kuwento na ipinark ni Arthur ang kanyang asul na kotse.", passage: "Ipinark ni Arthur ang kanyang asul na kotse sa ilalim ng malilim na puno ng oak. Pagbalik niya, nakita niyang natatakpan ng mga dilaw na dahon ang kotse."),
            ExerciseItem(prompt: "Ilang kandila ang inilagay ni Linda sa cake?", options: ["Sampu", "Lima", "Walo", "Labindalawa"], correctAnswer: "Sampu", explanation: "Nabanggit sa kuwento na naglagay siya ng sampung pulang kandila sa cake.", passage: "Nagbake si Linda ng chocolate cake para sa kaarawan ng kanyang anak na babae. Naglagay siya ng sampung pulang kandila sa ibabaw ng cake."),
            ExerciseItem(prompt: "Saan nakatira ang kapatid ni Robert?", options: ["Chicago", "New York", "Boston", "Miami"], correctAnswer: "Chicago", explanation: "Nabanggit sa kuwento na ipinadala niya ang pakete sa kanyang kapatid sa Chicago.", passage: "Pumunta si Robert sa post office upang magpadala ng pakete sa kanyang kapatid sa Chicago. Sinabi ng klerk na darating ito sa Martes."),
            ExerciseItem(prompt: "Ano ang kulay ng bagong sapatos ni Sarah?", options: ["Matingkad na berde", "Asul", "Pula", "Itim"], correctAnswer: "Matingkad na berde", explanation: "Nabanggit sa kuwento na ang sapatos ay kulay matingkad na berde.", passage: "Bumili si Sarah ng bagong sapatos para sa pagtakbo kahapon. Ito ay kulay matingkad na berde na may puting guhit."),
            ExerciseItem(prompt: "Anong kulay ng payong ang ginamit ni James?", options: ["Dilaw", "Pula", "Asul", "Itim"], correctAnswer: "Dilaw", explanation: "Nabanggit sa kuwento na binuksan niya ang kanyang dilaw na payong.", passage: "Naglalakad si James sa parke nang biglang umulan. Binuksan niya ang kanyang dilaw na payong upang hindi mabasa."),
            ExerciseItem(prompt: "Anong araw sarado ang panaderya?", options: ["Lunes", "Martes", "Miyerkules", "Linggo"], correctAnswer: "Lunes", explanation: "Nabanggit sa kuwento na sarado ang panaderya noong Lunes.", passage: "Sarado ang lokal na panaderya noong Lunes para sa mga kumpuni. Binalak nilang magbukas muli sa Martes ng umaga sa ikaseis."),
            ExerciseItem(prompt: "Bakit tumawag si Anna ng tubero?", options: ["May tagas ang kanyang sink", "Sira ang kanyang kalan", "Pundi ang ilaw", "Naka-lock ang pinto"], correctAnswer: "May tagas ang kanyang sink", explanation: "Nabanggit sa kuwento na tumawag siya ng tubero dahil may tagas ang sink sa kanyang kusina.", passage: "Tumawag si Anna ng tubero dahil may tagas ang sink sa kanyang kusina. Dumating ang tubero sa loob ng isang oras at inayos ang tubo."),
            ExerciseItem(prompt: "Ano ang pangalan ng aso ni David?", options: ["Max", "Buddy", "Charlie", "Rocky"], correctAnswer: "Max", explanation: "Nabanggit sa kuwento na inilakad ni David ang kanyang asong si Max.", passage: "Inilakad ni David ang kanyang asong si Max sa paligid ng block. Nakakita si Max ng isang ardilya (squirrel) at tinahulan ito nang malakas."),
            ExerciseItem(prompt: "Anong sahog ang naubos kay Helen?", options: ["Karot", "Patatas", "Sibuyas", "Kintsay"], correctAnswer: "Karot", explanation: "Nabanggit sa kuwento na nalaman niyang naubusan siya ng karot.", passage: "Nagluluto si Helen ng gulay na sopas para sa hapunan. Nalaman niyang naubusan na siya ng karot kaya patatas na lang ang kanyang ginamit."),
            ExerciseItem(prompt: "Magkano ang halaga ng tanghalian ni Peter?", options: ["Labinlimang dolyar", "Sampung dolyar", "Dalawampung dolyar", "Labindalawang dolyar"], correctAnswer: "Labinlimang dolyar", explanation: "Nabanggit sa kuwento na ang kabuuang halaga ay labinlimang dolyar.", passage: "Nag-order si Peter ng pepperoni pizza at isang bote ng soda para sa tanghalian. Ang kabuuang halaga ay labinlimang dolyar."),
            ExerciseItem(prompt: "Tungkol saan ang librong hiniram ni Alice?", options: ["Paghahalaman", "Kasaysayan", "Pagluluto", "Paglalakbay"], correctAnswer: "Paghahalaman", explanation: "Nabanggit sa kuwento na humiram siya ng libro tungkol sa paghahalaman.", passage: "Pumunta si Alice sa aklatan upang humiram ng libro tungkol sa paghahalaman. Humiram din siya ng DVD tungkol sa kasaysayan."),
            ExerciseItem(prompt: "Bakit naantala ang tren?", options: ["Pagpapanatili ng riles", "Malakas na bagyo", "Kawalan ng kuryente", "Nawawalang tauhan"], correctAnswer: "Pagpapanatili ng riles", explanation: "Nabanggit sa kuwento na naantala ang tren dahil sa pagpapanatili ng riles (track maintenance).", passage: "Sumakay si George ng tren sa umaga patungo sa lungsod para sa isang interbyu sa trabaho. Naantala ng labinlimang minuto ang tren dahil sa pagpapanatili ng riles."),
            ExerciseItem(prompt: "Anong bulaklak ang sa huli ay binili ni Nancy?", options: ["Pink na carnation", "Pulang rosas", "Dilaw na tulip", "Puting liryo"], correctAnswer: "Pink na carnation", explanation: "Nabanggit sa kuwento na pink na carnation ang kanyang binili sa huli.", passage: "Pumunta si Nancy sa garden center upang bumili ng pulang rosas. Ubos na ang mga ito, kaya pink na carnation ang kanyang binili.")
        ]
    )
