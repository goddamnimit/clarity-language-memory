...
struct VietnameseNewExercisesData {
    ...
    private static let exercise6 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "Thomas câu được loại cá gì?", options: ["Cá hồi", "Cá chép", "Cá vược", "Cá trê"], correctAnswer: "Cá hồi", explanation: "Câu chuyện ghi rõ anh ấy câu được một con cá hồi.", passage: "Thomas thức dậy sớm vào thứ Bảy để đi câu cá. Anh ấy câu được một con cá hồi lớn nhưng phải thả lại vì nó quá nhỏ so với quy định."),
            ExerciseItem(prompt: "Xe của Arthur có màu gì?", options: ["Màu xanh dương", "Màu vàng", "Màu đỏ", "Màu xanh lá"], correctAnswer: "Màu xanh dương", explanation: "Câu chuyện đề cập Arthur đỗ chiếc xe màu xanh dương.", passage: "Arthur đỗ chiếc xe hơi màu xanh dương dưới tán cây sồi mát mẻ. Khi quay lại, anh thấy xe bị phủ đầy lá vàng."),
            ExerciseItem(prompt: "Linda đã cắm bao nhiêu cây nến?", options: ["Mười", "Năm", "Tám", "Mười hai"], correctAnswer: "Mười", explanation: "Câu chuyện nói rằng cô cắm mười cây nến màu đỏ trên chiếc bánh.", passage: "Linda nướng một chiếc bánh kem sô-cô-la cho tiệc sinh nhật của con gái cô ấy. Cô ấy cắm mười cây nến màu đỏ lên bánh."),
            ExerciseItem(prompt: "Em trai Robert sống ở đâu?", options: ["Chicago", "New York", "Boston", "Miami"], correctAnswer: "Chicago", explanation: "Câu chuyện cho biết em trai của Robert sống ở Chicago.", passage: "Robert đến bưu điện để gửi một kiện hàng cho em trai mình ở Chicago. Nhân viên bưu điện báo kiện hàng sẽ đến vào thứ Ba."),
            ExerciseItem(prompt: "Đôi giày mới của Sarah có màu gì?", options: ["Xanh lá cây sáng", "Xanh dương", "Đỏ", "Đen"], correctAnswer: "Xanh lá cây sáng", explanation: "Câu chuyện nói rằng đôi giày có màu xanh lá sáng với các sọc trắng.", passage: "Sarah đã mua một đôi giày chạy bộ mới vào hôm qua. Chúng có màu xanh lá cây sáng với các sọc trắng."),
            ExerciseItem(prompt: "Chiếc ô của James có màu gì?", options: ["Màu vàng", "Màu đỏ", "Màu xanh dương", "Màu đen"], correctAnswer: "Màu vàng", explanation: "Câu chuyện nói anh ấy đã mở chiếc ô màu vàng.", passage: "James đang đi bộ trong công viên thì trời đổ mưa. Anh ấy mở chiếc ô màu vàng của mình để tránh bị ướt."),
            ExerciseItem(prompt: "Tiệm bánh đã đóng cửa vào ngày nào?", options: ["Thứ Hai", "Thứ Ba", "Thứ Tư", "Chủ Nhật"], correctAnswer: "Thứ Hai", explanation: "Câu chuyện nói rằng tiệm bánh đóng cửa vào thứ Hai.", passage: "Tiệm bánh địa phương đóng cửa vào thứ Hai để sửa chữa. Họ dự kiến mở cửa lại vào lúc sáu giờ sáng thứ Ba."),
            ExerciseItem(prompt: "Tại sao Anna gọi thợ sửa ống nước?", options: ["Bồn rửa bát bị rò rỉ", "Bếp ga bị hỏng", "Đèn bị tắt", "Cửa bị khóa"], correctAnswer: "Bồn rửa bát bị rò rỉ", explanation: "Câu chuyện nói cô gọi thợ vì bồn rửa bát bị rò rỉ nước.", passage: "Anna gọi thợ sửa ống nước vì bồn rửa bát trong bếp bị rò rỉ nước. Người thợ đến sau một tiếng và sửa xong đường ống."),
            ExerciseItem(prompt: "Tên chú chó của David là gì?", options: ["Max", "Buddy", "Charlie", "Rocky"], correctAnswer: "Max", explanation: "Câu chuyện cho biết chú chó của David tên là Max.", passage: "David dẫn chú chó của mình, tên là Max, đi dạo quanh khu phố. Max nhìn thấy một con sóc và sủa ầm ĩ."),
            ExerciseItem(prompt: "Helen đã hết nguyên liệu nào?", options: ["Cà rốt", "Khoai tây", "Hành tây", "Cần tây"], correctAnswer: "Cà rốt", explanation: "Câu chuyện nói cô ấy nhận ra nhà đã hết cà rốt.", passage: "Helen định nấu súp rau củ cho bữa tối. Cô ấy nhận ra nhà đã hết cà rốt nên đã dùng khoai tây để thay thế."),
            ExerciseItem(prompt: "Bữa trưa của Peter trị giá bao nhiêu?", options: ["Mười lăm đô-la", "Mười đô-la", "Hai mươi đô-la", "Mười hai đô-la"], correctAnswer: "Mười lăm đô-la", explanation: "Câu chuyện nêu rõ tổng chi phí là mười lăm đô-la.", passage: "Peter đặt một chiếc pizza xúc xích và một chai nước ngọt cho bữa trưa. Tổng chi phí là mười lăm đô-la."),
            ExerciseItem(prompt: "Cuốn sách Alice mượn viết về chủ đề gì?", options: ["Làm vườn", "Lịch sử", "Nấu ăn", "Du lịch"], correctAnswer: "Làm vườn", explanation: "Câu chuyện nói cô mượn sách về làm vườn.", passage: "Alice đến thư viện để mượn một cuốn sách về làm vườn. Cô ấy cũng mượn thêm một đĩa DVD lịch sử."),
            ExerciseItem(prompt: "Tại sao tàu bị trễ?", options: ["Bảo trì đường ray", "Bão lớn", "Mất điện", "Thiếu nhân viên"], correctAnswer: "Bảo trì đường ray", explanation: "Câu chuyện nêu rõ tàu bị trễ vì bảo trì đường ray.", passage: "George bắt chuyến tàu sáng sớm vào thành phố để phỏng vấn xin việc. Chuyến tàu bị trễ mười lăm phút do bảo trì đường ray."),
            ExerciseItem(prompt: "Nancy cuối cùng đã mua loại hoa nào?", options: ["Hoa cẩm chướng hồng", "Hoa hồng đỏ", "Hoa tulip vàng", "Hoa ly trắng"], correctAnswer: "Hoa cẩm chướng hồng", explanation: "Câu chuyện cho biết cô đã mua hoa cẩm chướng hồng thay thế.", passage: "Nancy đến cửa hàng hoa để mua hoa hồng đỏ. Cửa hàng hết hàng nên cô đã mua hoa cẩm chướng hồng.")
        ]
    )
