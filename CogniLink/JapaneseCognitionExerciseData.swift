...
struct JapaneseCognitionExerciseData {
    ...
    private static let exercise13 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "天皇制が象徴天皇制に移行したのはいつですか？", options: ["1935年", "1945年", "1947年", "1952年"], correctAnswer: "1947年", explanation: "第二次世界大戦後の1946年に公布された日本国憲法が1947年に施行されたことにより、天皇は主権者から「日本国および日本国民統合の象徴」へと正式に移行しました。"),
