...
struct SpanishNewExercisesData {
    ...
    private static let exercise2 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "COCINA", options: ["Estufa", "Cama", "Ducha", "Carro"], correctAnswer: "Estufa", explanation: "La estufa es un electrodoméstico principal en la cocina."),
            ...
            ExerciseItem(prompt: "CARRO", options: ["Neumático", "Ala", "Silla de montar", "Vela"], correctAnswer: "Neumático", explanation: "Los neumáticos son componentes esenciales de los carros."),
    ...
    private static let exercise4 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "LAVA + ___", options: ["Platos", "Manos", "Ropa", "Carro"], correctAnswer: "Platos", explanation: "Lava + Platos = Lavaplatos."),
    ...
    private static let exercise6 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "¿De qué color es el carro de Arturo?", options: ["Azul", "Amarillo", "Rojo", "Verde"], correctAnswer: "Azul", explanation: "La historia especifica que estacionó su carro azul.", passage: "Arturo estacionó su carro azul debajo de un roble sombreado. Cuando regresó, vio que el carro estaba cubierto de hojas amarillas."),
    ...
    private static let exercise8 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "Dejas encendidos los faros del carro toda la noche. ¿Qué pasará por la mañana?", options: ["El carro irá más rápido", "La batería estará descargada", "El carro cambiará de color", "El motor arrancará de inmediato"], correctAnswer: "La batería estará descargada", explanation: "Mantener los faros encendidos consume toda la energía de la batería."),
    ...
    private static let exercise13 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "Seguro de carro: Prima semestral: $600.00. ¿Con qué frecuencia se paga esta factura?", options: ["Cada mes", "Cada 6 meses (dos veces al año)", "Una vez al año", "Cada semana"], correctAnswer: "Cada 6 meses (dos veces al año)", explanation: "Semestral significa que corresponde a un período de seis meses."),
