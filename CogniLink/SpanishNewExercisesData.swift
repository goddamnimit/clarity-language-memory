...
struct SpanishNewExercisesData {
    ...
    private static let exercise6 = Exercise(
        ...
        difficulty: .medium,
        items: [
            ExerciseItem(prompt: "María fue a la tienda a comprar leche y pan. Olvidó su billetera en el mostrador de la cocina. ¿Qué dejó María en casa?", options: ["Su billetera", "Sus llaves", "Su lista de compras", "Su teléfono"], correctAnswer: "Su billetera", explanation: "La historia menciona que olvidó su billetera en la cocina."),
            ExerciseItem(prompt: "Tomás se despertó temprano el sábado para ir a pescar. Atrapó una trucha grande pero tuvo que devolverla porque era muy pequeña. ¿Qué tipo de pez atrapó Tomás?", options: ["Una trucha", "Un salmón", "Una lubina", "Un bagre"], correctAnswer: "Una trucha", explanation: "La historia dice explícitamente que atrapó una trucha grande."),
            ExerciseItem(prompt: "Arturo estacionó su coche azul debajo de un roble sombreado. Cuando regresó, vio que el coche estaba cubierto de hojas amarillas. ¿De qué color es el coche de Arturo?", options: ["Azul", "Amarillo", "Rojo", "Verde"], correctAnswer: "Azul", explanation: "La historia especifica que estacionó su coche azul."),
            ExerciseItem(prompt: "Linda horneó un pastel de chocolate para el cumpleaños de su hija. Puso diez velas rojas en el pastel. ¿Cuántas velas puso Linda en el pastel?", options: ["Diez", "Cinco", "Ocho", "Doce"], correctAnswer: "Diez", explanation: "La historia dice que puso diez velas rojas en el pastel."),
            ExerciseItem(prompt: "Roberto fue a la oficina de correos para enviar un paquete a su hermano en Chicago. El empleado le dijo que llegaría el martes. ¿Dónde vive el hermano de Roberto?", options: ["Chicago", "Nueva York", "Boston", "Miami"], correctAnswer: "Chicago", explanation: "La historia indica que envió el paquete a su hermano en Chicago."),
            ExerciseItem(prompt: "Sofía compró ayer un par de tenis nuevos para correr. Son de color verde brillante con rayas blancas. ¿De qué color son los tenis nuevos de Sofía?", options: ["Verde brillante", "Azul", "Rojo", "Negro"], correctAnswer: "Verde brillante", explanation: "La historia menciona que son de color verde brillante."),
            ExerciseItem(prompt: "Santiago caminaba por el parque cuando empezó a llover. Abrió su paraguas amarillo para mantenerse seco. ¿De qué color era el paraguas de Santiago?", options: ["Amarillo", "Rojo", "Azul", "Negro"], correctAnswer: "Amarillo", explanation: "La historia indica que abrió su paraguas amarillo."),
            ExerciseItem(prompt: "La panadería local cerró el lunes por reparaciones. Planeaban reabrir el martes por la mañana a las seis en punto. ¿Qué día estuvo cerrada la panadería?", options: ["Lunes", "Martes", "Miércoles", "Domingo"], correctAnswer: "Lunes", explanation: "La historia explica que cerró el lunes por reparaciones."),
            ExerciseItem(prompt: "Ana llamó a un plomero porque el fregadero de la cocina goteaba. El plomero llegó en una hora y arregló la tubería. ¿Por qué llamó Ana a un plomero?", options: ["Su fregadero goteaba", "Su estufa estaba rota", "No tenía luz", "Su puerta estaba trabada"], correctAnswer: "Su fregadero goteaba", explanation: "La historia dice que llamó al plomero porque el fregadero de la cocina goteaba."),
            ExerciseItem(prompt: "David paseó a su perro, Max, por la manzana. Max vio una ardilla y le ladró fuerte. ¿Cómo se llama el perro de David?", options: ["Max", "Buddy", "Charlie", "Rocky"], correctAnswer: "Max", explanation: "La historia presenta al perro de David como Max."),
            ExerciseItem(prompt: "Elena estaba preparando sopa de verduras para la cena. Se dio cuenta de que no le quedaban zanahorias, así que usó papas en su lugar. ¿De qué ingrediente se quedó sin existencias Elena?", options: ["Zanahorias", "Papas", "Cebollas", "Apio"], correctAnswer: "Zanahorias", explanation: "La historia señala que se dio cuenta de que no le quedaban zanahorias."),
            ExerciseItem(prompt: "Pedro pidió una pizza de pepperoni y un refresco para el almuerzo. El costo total fue de quince dólares. ¿Cuánto costó el almuerzo de Pedro?", options: ["Quince dólares", "Diez dólares", "Veinte dólares", "Doce dólares"], correctAnswer: "Quince dólares", explanation: "La historia establece que el costo total fue de quince dólares."),
            ExerciseItem(prompt: "Alicia fue a la biblioteca a pedir prestado un libro sobre jardinería. También se llevó un DVD de historia. ¿De qué tema era el libro que pidió prestado Alicia?", options: ["Jardinería", "Historia", "Cocina", "Viajes"], correctAnswer: "Jardinería", explanation: "La historia afirma que pidió prestado un libro sobre jardinería."),
            ExerciseItem(prompt: "Jorge tomó un tren matutino a la ciudad para una entrevista de trabajo. El tren se retrasó quince minutos debido al mantenimiento de las vías. ¿Por qué se retrasó el tren?", options: ["Mantenimiento de las vías", "Una fuerte tormenta", "Un apagón de luz", "Falta de personal"], correctAnswer: "Mantenimiento de las vías", explanation: "La historia indica que el tren se retrasó debido al mantenimiento de las vías."),
            ExerciseItem(prompt: "Nancy fue al vivero a comprar rosas rojas. Estaban agotadas, así que compró claveles rosados en su lugar. ¿Qué flor terminó comprando Nancy?", options: ["Claveles rosados", "Rosas rojas", "Tulipanes amarillos", "Lirios blancos"], correctAnswer: "Claveles rosados", explanation: "La historia menciona que compró claveles rosados en su lugar.")
        ]
    )
