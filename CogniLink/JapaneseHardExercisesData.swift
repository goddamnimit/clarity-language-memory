...
struct JapaneseHardExercisesData {
    ...
    private static let exercise4 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "フレッド・コレマツが最高裁判所で再審を求めたのは何年ですか？", options: ["1965年", "1975年", "1983年", "1988年"], correctAnswer: "1983年", explanation: "日系人強制収容の違憲性を訴えたフレッド・コレマツが、政府の証拠隠蔽を理由に再審を求めたのが1983年であるためです。"),
