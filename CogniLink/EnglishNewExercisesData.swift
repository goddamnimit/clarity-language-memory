...
struct EnglishNewExercisesData {
    ...
    private static let exercise6 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "What kind of fish did Thomas catch?", options: ["A trout", "A salmon", "A bass", "A catfish"], correctAnswer: "A trout", explanation: "The story states he caught a large trout.", passage: "Thomas woke up early on Saturday to go fishing. He caught a large trout but had to throw it back because it was too small."),
            ExerciseItem(prompt: "What color is Arthur’s car?", options: ["Blue", "Yellow", "Red", "Green"], correctAnswer: "Blue", explanation: "The story states Arthur parked his blue car.", passage: "Arthur parked his blue car under a shady oak tree. When he returned, he saw that the car was covered in yellow leaves."),
            ExerciseItem(prompt: "How many candles did Linda put on the cake?", options: ["Ten", "Five", "Eight", "Twelve"], correctAnswer: "Ten", explanation: "The story states she put ten red candles on the cake.", passage: "Linda baked a chocolate cake for her daughter’s birthday party. She put ten red candles on the cake."),
            ExerciseItem(prompt: "Where does Robert’s brother live?", options: ["Chicago", "New York", "Boston", "Miami"], correctAnswer: "Chicago", explanation: "The story states he mailed a package to his brother in Chicago.", passage: "Robert went to the post office to mail a package to his brother in Chicago. The clerk told him it would arrive on Tuesday."),
            ExerciseItem(prompt: "What color are Sarah’s new running shoes?", options: ["Bright green", "Blue", "Red", "Black"], correctAnswer: "Bright green", explanation: "The story says the shoes are bright green with white stripes.", passage: "Sarah bought a new pair of running shoes yesterday. They are bright green with white stripes."),
            ExerciseItem(prompt: "What color was the umbrella James used?", options: ["Yellow", "Red", "Blue", "Black"], correctAnswer: "Yellow", explanation: "The story says he opened his yellow umbrella.", passage: "James was walking in the park when it started raining. He opened his yellow umbrella to stay dry."),
            ExerciseItem(prompt: "What day was the bakery closed?", options: ["Monday", "Tuesday", "Wednesday", "Sunday"], correctAnswer: "Monday", explanation: "The story says the bakery was closed on Monday.", passage: "The local bakery was closed on Monday for repairs. They planned to reopen on Tuesday morning at six o’clock."),
            ExerciseItem(prompt: "Why did Anna call a plumber?", options: ["Her sink was leaking", "Her stove was broken", "Her light was out", "Her door was locked"], correctAnswer: "Her sink was leaking", explanation: "The story says she called a plumber because her kitchen sink was leaking.", passage: "Anna called a plumber because her kitchen sink was leaking. The plumber arrived in an hour and fixed the pipe."),
            ExerciseItem(prompt: "What is the name of David’s dog?", options: ["Max", "Buddy", "Charlie", "Rocky"], correctAnswer: "Max", explanation: "The story states David walked his dog, Max.", passage: "David walked his dog, Max, around the block. Max saw a squirrel and barked loudly at it."),
            ExerciseItem(prompt: "What ingredient did Helen run out of?", options: ["Carrots", "Potatoes", "Onions", "Celery"], correctAnswer: "Carrots", explanation: "The story states she realized she was out of carrots.", passage: "Helen was making vegetable soup for dinner. She realized she was out of carrots, so she used potatoes instead."),
            ExerciseItem(prompt: "How much did Peter’s lunch cost?", options: ["Fifteen dollars", "Ten dollars", "Twenty dollars", "Twelve dollars"], correctAnswer: "Fifteen dollars", explanation: "The story states the total cost was fifteen dollars.", passage: "Peter ordered a pepperoni pizza and a bottle of soda for lunch. The total cost was fifteen dollars."),
            ExerciseItem(prompt: "What subject was the book Alice borrowed about?", options: ["Gardening", "History", "Cooking", "Travel"], correctAnswer: "Gardening", explanation: "The story states she borrowed a book about gardening.", passage: "Alice went to the library to borrow a book about gardening. She also borrowed a DVD about history."),
            ExerciseItem(prompt: "Why was the train delayed?", options: ["Track maintenance", "A heavy storm", "A power outage", "A missing crew member"], correctAnswer: "Track maintenance", explanation: "The story states the train was delayed due to track maintenance.", passage: "George took a morning train to the city for a job interview. His train was delayed by fifteen minutes due to track maintenance."),
            ExerciseItem(prompt: "What flower did Nancy end up buying?", options: ["Pink carnations", "Red roses", "Yellow tulips", "White lilies"], correctAnswer: "Pink carnations", explanation: "The story states she bought pink carnations instead.", passage: "Nancy went to the garden center to buy red roses. They were sold out, so she bought pink carnations instead.")
        ]
    )
