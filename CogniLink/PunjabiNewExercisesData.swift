...
struct PunjabiNewExercisesData {
    ...
    private static let exercise2 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "ਲਾਇਬ੍ਰੇਰੀ", options: ["ਕਿਤਾਬਾਂ", "ਕੱਪੜੇ", "ਸੰਦ", "ਸਬਜ਼ੀਆਂ"], correctAnswer: "ਕਿਤਾਬਾਂ", explanation: "ਲਾਇਬ੍ਰੇਰੀਆਂ ਵਿੱਚ ਕਿਤਾਬਾਂ ਸਟੋਰ ਕੀਤੀਆਂ ਅਤੇ ਉਧਾਰ ਦਿੱਤੀਆਂ ਜਾਂਦੀਆਂ ਹਨ।"),
            ...
            ExerciseItem(prompt: "ਮਕੜੀ", options: ["ਜਾਲਾ", "ਆਲ੍ਹਣਾ", "ਖੱਤਾ", "ਗੁਫਾ"], correctAnswer: "ਜਾਲਾ", explanation: "ਮਕੜੀ ਜਾਲਾ ਬੁਣਦੀ ਹੈ।"),
    ...
    private static let exercise6 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "ਥਾਮਸ ਨੇ ਕਿਸ ਕਿਸਮ ਦੀ ਮੱਛੀ ਫੜੀ ਸੀ?", options: ["ਟਰਾਊਟ ਮੱਛੀ", "ਸੈਲਮਨ ਮੱਛੀ", "ਬਾਸ ਮੱਛੀ", "ਕੈਟਫਿਸ਼"], correctAnswer: "ਟਰਾਊਟ ਮੱਛੀ", explanation: "ਕਹਾਣੀ ਵਿੱਚ ਸਪੱਸ਼ਟ ਦੱਸਿਆ ਗਿਆ ਹੈ ਕਿ ਉਸਨੇ ਟਰਾਊਟ ਮੱਛੀ ਫੜੀ ਸੀ।", passage: "ਥਾਮਸ ਸ਼ਨੀਵਾਰ ਨੂੰ ਤੜਕੇ ਮੱਛੀ ਫੜਨ ਲਈ ਜਾਗਿਆ। ਉਸਨੇ ਇੱਕ ਵੱਡੀ ਟਰਾਊਟ ਮੱਛੀ ਫੜੀ ਪਰ ਉਸਨੂੰ ਵਾਪਸ ਸੁੱਟਣਾ ਪਿਆ ਕਿਉਂਕਿ ਉਹ ਬਹੁਤ ਛੋਟੀ ਸੀ।"),
            ExerciseItem(prompt: "ਆਰਥਰ ਦੀ ਕਾਰ ਦਾ ਰੰਗ ਕੀ ਹੈ?", options: ["ਨੀਲਾ", "ਪੀਲਾ", "ਲਾਲ", "ਹਰਾ"], correctAnswer: "ਨੀਲਾ", explanation: "ਕਹਾਣੀ ਮੁਤਾਬਕ ਆਰਥਰ ਨੇ ਆਪਣੀ 'ਨੀਲੀ ਕਾਰ' ਖੜ੍ਹੀ ਕੀਤੀ ਸੀ।", passage: "ਆਰਥਰ ਨੇ ਆਪਣੀ ਨੀਲੀ ਕਾਰ ਇੱਕ ਛਾਂਦਾਰ ਬੋਹੜ ਦੇ ਦਰੱਖਤ ਹੇਠਾਂ ਖੜ੍ਹੀ ਕੀਤੀ। ਜਦੋਂ ਉਹ ਵਾਪਸ ਆਇਆ, ਉਸਨੇ ਦੇਖਿਆ ਕਿ ਕਾਰ ਪੀਲੇ ਪੱਤਿਆਂ ਨਾਲ ਢੱਕੀ ਹੋਈ ਸੀ।"),
            ExerciseItem(prompt: "ਲਿੰਡਾ ਨੇ ਕੇਕ 'ਤੇ ਕਿੰਨੀਆਂ ਮੋਮਬੱਤੀਆਂ ਲਗਾਈਆਂ?", options: ["ਦਸ", "ਪੰਜ", "ਅੱਠ", "ਬਾਰਾਂ"], correctAnswer: "ਦਸ", explanation: "ਕਹਾਣੀ ਅਨੁਸਾਰ ਉਸਨੇ ਕੇਕ 'ਤੇ ਦਸ ਲਾਲ ਮੋਮਬੱਤੀਆਂ ਲਗਾਈਆਂ ਸਨ।", passage: "ਲਿੰਡਾ ਨੇ ਆਪਣੀ ਬੇਟੀ ਦੇ ਜਨਮਦਿਨ ਦੀ ਪਾਰਟੀ ਲਈ ਇੱਕ ਚਾਕਲੇਟ ਕੇਕ ਬਣਾਇਆ। ਉਸਨੇ ਕੇਕ 'ਤੇ ਦਸ ਲਾਲ ਮੋਮਬੱਤੀਆਂ ਲਗਾਈਆਂ।"),
            ExerciseItem(prompt: "ਰੌਬਰਟ ਦਾ ਭਰਾ ਕਿੱਥੇ ਰਹਿੰਦਾ ਹੈ?", options: ["ਸ਼ਿਕਾਗੋ", "ਨਿਊਯਾਰਕ", "ਬੋਸਟਨ", "ਮਿਆਮੀ"], correctAnswer: "ਸ਼ਿਕਾਗੋ", explanation: "ਕਹਾਣੀ ਮੁਤਾਬਕ ਉਸਨੇ ਸ਼ਿਕਾਗੋ ਵਿੱਚ ਰਹਿੰਦੇ ਆਪਣੇ ਭਰਾ ਨੂੰ ਪਾਰਸਲ ਭੇਜਿਆ ਸੀ।", passage: "ਰੌਬਰਟ ਸ਼ਿਕਾਗੋ ਵਿੱਚ ਆਪਣੇ ਭਰਾ ਨੂੰ ਇੱਕ ਪਾਰਸਲ ਭੇਜਣ ਲਈ ਡਾਕਖਾਨੇ ਗਿਆ। ਕਲਰਕ ਨੇ ਉਸਨੂੰ ਦੱਸਿਆ ਕਿ ਇਹ ਮੰਗਲਵਾਰ ਨੂੰ ਪਹੁੰਚੇਗਾ।"),
            ExerciseItem(prompt: "ਸਾਰਾਹ ਦੇ ਨਵੇਂ ਜੁੱਤੇ ਕਿਸ ਰੰਗ ਦੇ ਹਨ?", options: ["ਚਮਕਦਾਰ ਹਰਾ", "ਨੀਲਾ", "ਲਾਲ", "ਕਾਲਾ"], correctAnswer: "ਚਮਕਦਾਰ ਹਰਾ", explanation: "ਕਹਾਣੀ ਵਿੱਚ ਲਿਖਿਆ ਹੈ ਕਿ ਜੁੱਤੇ ਚਿੱਟੀਆਂ ਪੱਟੀਆਂ ਵਾਲੇ ਚਮਕਦਾਰ ਹਰੇ ਰੰਗ ਦੇ ਹਨ।", passage: "ਸਾਰਾਹ ਨੇ ਕੱਲ੍ਹ ਦੌੜਨ ਵਾਲੇ ਨਵੇਂ ਜੁੱਤੇ ਖਰੀਦੇ ਸਨ। ਉਹ ਚਿੱਟੀਆਂ ਪੱਟੀਆਂ ਵਾਲੇ ਚਮਕਦਾਰ ਹਰੇ ਰੰਗ ਦੇ ਹਨ।"),
            ExerciseItem(prompt: "ਜੇਮਜ਼ ਨੇ ਕਿਸ ਰੰਗ ਦੀ ਛਤਰੀ ਦੀ ਵਰਤੋਂ ਕੀਤੀ?", options: ["ਪੀਲੀ", "ਲਾਲ", "ਨੀਲੀ", "ਕਾਲੀ"], correctAnswer: "ਪੀਲੀ", explanation: "ਕਹਾਣੀ ਵਿੱਚ ਦੱਸਿਆ ਗਿਆ ਹੈ ਕਿ ਉਸਨੇ ਆਪਣੀ ਪੀਲੀ ਛਤਰੀ ਖੋਲ੍ਹੀ ਸੀ।", passage: "ਜੇਮਜ਼ ਪਾਰਕ ਵਿੱਚ ਘੁੰਮ ਰਿਹਾ ਸੀ ਜਦੋਂ ਮੀਂਹ ਪੈਣਾ ਸ਼ੁਰੂ ਹੋ ਗਿਆ। ਸੁੱਕੇ ਰਹਿਣ ਲਈ ਉਸਨੇ ਆਪਣੀ ਪੀਲੀ ਛਤਰੀ ਖੋਲ੍ਹ ਲਈ।"),
            ExerciseItem(prompt: "ਬੇਕਰੀ ਕਿਸ ਦਿਨ ਬੰਦ ਸੀ?", options: ["ਸੋਮਵਾਰ", "ਮੰਗਲਵਾਰ", "ਬੁੱਧਵਾਰ", "ਐਤਵਾਰ"], correctAnswer: "ਸੋਮਵਾਰ", explanation: "ਕਹਾਣੀ ਮੁਤਾਬਕ ਬੇਕਰੀ ਸੋਮਵਾਰ ਨੂੰ ਬੰਦ ਸੀ।", passage: "ਸਥਾਨਕ ਬੇਕਰੀ ਮੁਰੰਮਤ ਲਈ ਸੋਮਵਾਰ ਨੂੰ ਬੰਦ ਸੀ। ਉਨ੍ਹਾਂ ਨੇ ਮੰਗਲਵਾਰ ਸਵੇਰੇ ਛੇ ਵਜੇ ਦੁਬਾਰਾ ਖੋਲ੍ਹਣ ਦੀ ਯੋਜਨਾ ਬਣਾਈ ਸੀ।"),
            ExerciseItem(prompt: "ਐਨਾ ਨੇ ਪਲੰਬਰ ਨੂੰ ਕਿਉਂ ਬੁਲਾਇਆ ਸੀ?", options: ["ਉਸਦੀ ਸਿੰਕ ਲੀਕ ਹੋ ਰਹੀ ਸੀ", "ਉਸਦਾ ਚੁੱਲ੍ਹਾ ਟੁੱਟ ਗਿਆ ਸੀ", "ਲਾਈਟ ਬੰਦ ਸੀ", "ਦਰਵਾਜ਼ਾ ਬੰਦ ਸੀ"], correctAnswer: "ਉਸਦੀ ਸਿੰਕ ਲੀਕ ਹੋ ਰਹੀ ਸੀ", explanation: "ਕਹਾਣੀ ਵਿੱਚ ਦੱਸਿਆ ਗਿਆ ਹੈ ਕਿ ਉਸਦੀ ਰਸੋਈ ਦੀ ਸਿੰਕ ਲੀਕ ਹੋਣ ਕਾਰਨ ਉਸਨੇ ਪਲੰਬਰ ਬੁਲਾਇਆ ਸੀ।", passage: "ਐਨਾ ਨੇ ਪਲੰਬਰ ਨੂੰ ਬੁਲਾਇਆ ਕਿਉਂਕਿ ਉਸਦੀ ਰਸੋਈ ਦੀ ਸਿੰਕ ਲੀਕ ਹੋ ਰਹੀ ਸੀ। ਪਲੰਬਰ ਇੱਕ ਘੰਟੇ ਵਿੱਚ ਪਹੁੰਚਿਆ ਅਤੇ ਪਾਈਪ ਠੀਕ ਕਰ ਦਿੱਤੀ।"),
            ExerciseItem(prompt: "ਡੇਵਿਡ ਦੇ ਕੁੱਤੇ ਦਾ ਕੀ ਨਾਮ ਹੈ?", options: ["ਮੈਕਸ", "ਬੱਡੀ", "ਚਾਰਲੀ", "ਰੌਕੀ"], correctAnswer: "ਮੈਕਸ", explanation: "ਕਹਾਣੀ ਮੁਤਾਬਕ ਡੇਵਿਡ ਦੇ ਕੁੱਤੇ ਦਾ ਨਾਮ ਮੈਕਸ ਹੈ।", passage: "ਡੇਵਿਡ ਆਪਣੇ ਕੁੱਤੇ, ਮੈਕਸ, ਨੂੰ ਗਲੀ ਵਿੱਚ ਘੁੰਮਾ ਰਿਹਾ ਸੀ। ਮੈਕਸ ਨੇ ਇੱਕ ਗਿਲਹਰੀ ਦੇਖੀ ਅਤੇ ਉਸ 'ਤੇ ਉੱਚੀ-ਉੱਚੀ ਭੌਂਕਿਆ।"),
            ExerciseItem(prompt: "ਹੈਲਨ ਕੋਲ ਕਿਹੜੀ ਚੀਜ਼ ਖ਼ਤਮ ਹੋ ਗਈ ਸੀ?", options: ["ਗਾਜਰਾਂ", "ਆਲੂ", "ਪਿਆਜ਼", "ਸੈਲਰੀ"], correctAnswer: "ਗਾਜਰਾਂ", explanation: "ਕਹਾਣੀ ਵਿੱਚ ਲਿਖਿਆ ਹੈ ਕਿ ਗਾਜਰਾਂ ਖ਼ਤਮ ਹੋਣ ਕਰਕੇ ਉਸਨੇ ਆਲੂਆਂ ਦੀ ਵਰਤੋਂ ਕੀਤੀ ਸੀ।", passage: "ਹੈਲਨ ਰਾਤ ਦੇ ਖਾਣੇ ਲਈ ਸਬਜ਼ੀਆਂ ਦਾ ਸੂਪ ਬਣਾ ਰਹੀ ਸੀ। ਉਸਨੂੰ ਅਹਿਸਾਸ ਹੋਇਆ ਕਿ ਗਾਜਰਾਂ ਖ਼ਤਮ ਹੋ ਗਈਆਂ ਹਨ, ਇਸ ਲਈ ਉਸਨੇ ਆਲੂਆਂ ਦੀ ਵਰਤੋਂ ਕੀਤੀ।"),
            ExerciseItem(prompt: "ਪੀਟਰ ਦੇ ਦੁਪਹਿਰ ਦੇ ਖਾਣੇ 'ਤੇ ਕਿੰਨੇ ਪੈਸੇ ਖਰਚ ਹੋਏ?", options: ["ਪੰਦਰਾਂ ਡਾਲਰ", "ਦਸ ਡਾਲਰ", "ਵੀਹ ਡਾਲਰ", "ਬਾਰਾਂ ਡਾਲਰ"], correctAnswer: "ਪੰਦਰਾਂ ਡਾਲਰ", explanation: "ਕਹਾਣੀ ਅਨੁਸਾਰ ਕੁੱਲ ਖਰਚਾ ਪੰਦਰਾਂ ਡਾਲਰ ਸੀ।", passage: "ਪੀਟਰ ਨੇ ਦੁਪਹਿਰ ਦੇ ਖਾਣੇ ਲਈ ਇੱਕ ਪੇਪਰੋਨੀ ਪੀਜ਼ਾ ਅਤੇ ਸੋਡੇ ਦੀ ਬੋਤਲ ਦਾ ਆਰਡਰ ਦਿੱਤਾ। ਕੁੱਲ ਕੀਮਤ ਪੰਦਰਾਂ ਡਾਲਰ ਸੀ।"),
            ExerciseItem(prompt: "ਐਲਿਸ ਦੁਆਰਾ ਉਧਾਰ ਲਈ ਗਈ ਕਿਤਾਬ ਕਿਸ ਵਿਸ਼ੇ ਬਾਰੇ ਸੀ?", options: ["ਬਾਗਬਾਨੀ", "ਇਤਿਹਾਸ", "ਖਾਣਾ ਪਕਾਉਣਾ", "ਯਾਤਰਾ"], correctAnswer: "ਬਾਗਬਾਨੀ", explanation: "ਕਹਾਣੀ ਅਨੁਸਾਰ ਉਸਨੇ ਬਾਗਬਾਨੀ ਬਾਰੇ ਕਿਤਾਬ ਉਧਾਰ ਲਈ ਸੀ।", passage: "ਐਲਿਸ ਬਾਗਬਾਨੀ ਬਾਰੇ ਇੱਕ ਕਿਤਾਬ ਉਧਾਰ ਲੈਣ ਲਈ ਲਾਇਬ੍ਰੇਰੀ ਗਈ ਸੀ। ਉਸਨੇ ਇਤਿਹਾਸ ਬਾਰੇ ਇੱਕ ਡੀਵੀਡੀ ਵੀ ਉਧਾਰ ਲਈ।"),
            ExerciseItem(prompt: "ਰੇਲਗੱਡੀ ਲੇਟ ਕਿਉਂ ਹੋਈ ਸੀ?", options: ["ਪਟੜੀ ਦੀ ਮੁਰੰਮਤ ਕਾਰਨ", "ਤੇਜ਼ ਤੂਫ਼ਾਨ ਕਾਰਨ", "ਬਿਜਲੀ ਜਾਣ ਕਾਰਨ", "ਅਮਲੇ ਦੀ ਕਮੀ ਕਾਰਨ"], correctAnswer: "ਪਟੜੀ ਦੀ ਮੁਰੰਮਤ ਕਾਰਨ", explanation: "ਕਹਾਣੀ ਅਨੁਸਾਰ ਪਟੜੀ ਦੀ ਮੁਰੰਮਤ ਕਾਰਨ ਰੇਲਗੱਡੀ ਵਿੱਚ ਦੇਰੀ ਹੋਈ ਸੀ।", passage: "ਜਾਰਜ ਨੌਕਰੀ ਦੇ ਇੰਟਰਵਿਊ ਲਈ ਸਵੇਰ ਦੀ ਰੇਲਗੱਡੀ ਰਾਹੀਂ ਸ਼ਹਿਰ ਗਿਆ ਸੀ। ਪਟੜੀ ਦੀ ਮੁਰੰਮਤ ਕਾਰਨ ਉਸਦੀ ਰੇਲਗੱਡੀ ਪੰਦਰਾਂ ਮਿੰਟ ਲੇਟ ਹੋ ਗਈ ਸੀ।"),
            ExerciseItem(prompt: "ਨੈਂਸੀ ਨੇ ਆਖਰਕਾਰ ਕਿਹੜਾ ਫੁੱਲ ਖਰੀਦਿਆ?", options: ["ਗੁਲਾਬੀ ਕਾਰਨੇਸ਼ਨ", "ਲਾਲ ਗੁਲਾਬ", "ਪੀਲੇ ਟਿਊਲਿਪ", "ਚਿੱਟੇ ਲਿਲੀ"], correctAnswer: "ਗੁਲਾਬੀ ਕਾਰਨੇਸ਼ਨ", explanation: "ਕਹਾਣੀ ਅਨੁਸਾਰ ਨੈਂਸੀ ਨੇ ਗੁਲਾਬੀ ਕਾਰਨੇਸ਼ਨ ਦੇ ਫੁੱਲ ਖਰੀਦੇ ਸਨ।", passage: "ਨੈਂਸੀ ਲਾਲ ਗੁਲਾਬ ਖਰੀਦਣ ਲਈ ਨਰਸਰੀ ਗਈ। ਉਹ ਖ਼ਤਮ ਹੋ ਚੁੱਕੇ ਸਨ, ਇਸ ਲਈ ਉਸਨੇ ਗੁਲਾਬੀ ਕਾਰਨੇਸ਼ਨ ਖਰੀਦੇ।")
        ]
    )
    ...
    private static let exercise8 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "ਰਾਤ ਭਰ ਭਾਰੀ ਬਰਫ਼ਬਾਰੀ ਹੁੰਦੀ ਹੈ, ਜਿਸ ਨਾਲ ਛੇ ਇੰਚ ਬਰਫ਼ ਜਮ੍ਹਾਂ ਹੋ ਜਾਂਦੀ ਹੈ। ਸੜਕਾਂ ਦਾ ਕੀ ਹੁੰਦਾ ਹੈ?", options: ["ਉਹ ਸੁੱਕੀਆਂ ਰਹਿੰਦੀਆਂ ਹਨ", "ਉਹ ਤਿਲਕਣ ਵਾਲੀਆਂ ਅਤੇ ਬਰਫ਼ ਨਾਲ ਢੱਕੀਆਂ ਹੋ ਜਾਂਦੀਆਂ ਹਨ", "ਉਹ ਹਰੀਆਂ ਹੋ ਜਾਂਦੀਆਂ ਹਨ", "ਉਹ ਉੱਡ ਜਾਂਦੀਆਂ ਹਨ"], correctAnswer: "ਉਹ ਤਿਲਕਣ ਵਾਲੀਆਂ ਅਤੇ ਬਰਫ਼ ਨਾਲ ਢੱਕੀਆਂ ਹੋ ਜਾਂਦੀਆਂ ਹਨ", explanation: "ਬਰਫ਼ਬਾਰੀ ਕਾਰਨ ਸੜਕਾਂ 'ਤੇ ਬਰਫ਼ ਜਮ੍ਹਾਂ ਹੋ ਜਾਂ ਹੋ ਜਾਂਦੀ ਹੈ ਜਿਸ ਨਾਲ ਤਿਲਕਣ ਵੱਧ ਜਾਂਦੀ ਹੈ।"),
