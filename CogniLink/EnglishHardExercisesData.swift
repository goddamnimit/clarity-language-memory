...
struct EnglishHardExercisesData {
    ...
    private static let exercise9 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "[road / rode] The car drove on the ___. She ___ her horse in the park.", options: ["road...rode", "rode...road", "road...road", "rode...rode"], correctAnswer: "road...rode", explanation: "Road is a paved path for driving, while rode is the past tense of ride."),
            ...
            ExerciseItem(prompt: "[wood / would] The table is made of ___. ___ you like a cup of tea?", options: ["wood...would", "would...wood", "wood...wood", "would...would"], correctAnswer: "wood...would", explanation: "Wood is material from trees, while would is a verb expressing desire or intent."),
            ...
            ExerciseItem(prompt: "[one / won] I have ___ dog. Our team ___ the game.", options: ["one...won", "won...one", "one...one", "won...won"], correctAnswer: "one...won", explanation: "One is the number 1, while won is the past tense of win.")
        ]
    )
    ...
    private static let hardCompleteSaying = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "Politics makes strange ___", options: ["bedfellows", "partners", "friends", "allies"], correctAnswer: "bedfellows", explanation: "The proverb is 'Politics makes strange bedfellows.'"),
