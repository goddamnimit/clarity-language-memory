...
struct VietnameseHardExercisesData {
    ...
    private static let exercise1 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "[đông / đông] Mùa ___ Westminster rất lạnh. Đường phố chiều nay rất ___ đúc.", options: ["đông...đông", "đông...tây", "tây...đông", "đông...nam"], correctAnswer: "đông...đông", explanation: "'Đông' (mùa đông) và 'đông' (đông đúc) là từ đồng âm."),
            ...
            ExerciseItem(prompt: "[kinh / kinh] Westminster được xem là ___ đô của người Việt hải ngoại. Sư thầy đang tụng ___ trong chùa.", options: ["kinh...kinh", "kinh...sách", "sách...kinh", "kinh...đô"], correctAnswer: "kinh...kinh", explanation: "'Kinh' (kinh đô, thủ đô) và 'kinh' (kinh sách) là hai từ đồng âm."),
