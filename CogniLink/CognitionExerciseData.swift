...
struct CognitionExerciseData {
    ...
    private static let exercise6 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "How many days are in a leap year?", options: ["364", "365", "366", "367"], correctAnswer: "366", explanation: "A leap year adds one extra day, February 29th, to the standard 365-day calendar, making it 366 days total."),
    ...
    private static let exercise9 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "In which country would you find the Great Pyramid of Giza?", options: ["Morocco", "Tunisia", "Libya", "Egypt"], correctAnswer: "Egypt", explanation: "The Great Pyramid of Giza, one of the Seven Wonders of the Ancient World, is located near Cairo in Egypt."),
    ...
    private static let exercise12 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "Approximately how many gallons of water does a standard bathtub hold during a typical bath?", options: ["5 gallons", "15 gallons", "30 to 40 gallons", "100 gallons"], correctAnswer: "30 to 40 gallons", explanation: "A standard-sized bathtub typically holds around 30 to 40 gallons of water for a normal bath, well below its rim-full capacity."),
            ...
            ExerciseItem(id: UUID(), prompt: "How many ounces are in a standard 5-pound bag of flour?", options: ["40 oz", "80 oz", "100 oz", "160 oz"], correctAnswer: "80 oz", explanation: "Since there are 16 ounces in a pound, a 5-pound bag contains 5 times 16, or 80 ounces."),
