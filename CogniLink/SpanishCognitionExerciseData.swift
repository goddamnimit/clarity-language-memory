...
struct SpanishCognitionExerciseData {
    ...
    private static let exercise3 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "¿Quién fue la Madre Teresa?", options: ["Una política que luchó por los derechos de la mujer", "Una científica que descubrió la penicilina", "Una monja y humanitaria que cuidó a los pobres en India", "Una activista de los derechos civiles en EE.UU."], correctAnswer: "Una monja and humanitaria que cuidó a los pobres en India", explanation: ""),
    ...
    private static let exercise12 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "¿Cuántos años hay en un siglo?", options: ["10", "50", "100", "1000"], correctAnswer: "100", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "¿Es un elefante más grande que un ratón?", options: ["Sí", "No"], correctAnswer: "Sí", explanation: ""),
            // fingers
            ExerciseItem(id: UUID(), prompt: "¿Los humanos tienen 10 dedos en las manos, incluidos los pulgares?", options: ["Sí", "No"], correctAnswer: "Sí", explanation: ""),
