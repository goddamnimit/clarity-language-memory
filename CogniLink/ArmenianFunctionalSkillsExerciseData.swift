    ...
    private static let readingMenu = Exercise(
        ...
        items: [
            ...
            ExerciseItem(
                ...
                correctAnswer: "$6.50",
                explanation: "Խնձորի կարկանդակի գինը $5,00 է, և վանիլային պաղպաղակի ավելացումը արժե ևս $1,50, հետևաբար $5,00 գումարած $1,50 հավասար է $6,50։"
            ),
            ExerciseItem(
                id: UUID(),
    ...
    private static let understandingBills = Exercise(
        ...
        items: [
            ...
            ExerciseItem(
                ...
                explanation: "Տարեկան վճարը տրված է ուղղակիորեն որպես $120,00. ամսական $10,00 գումարը վերաբերում է առանձին վճարային տարբերակին և հարցի պատասխանի հաշվարկի մաս չի կազմում։"
            ),
            ExerciseItem(
                id: UUID(),
