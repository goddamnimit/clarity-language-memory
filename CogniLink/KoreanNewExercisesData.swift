...
struct KoreanNewExercisesData {
    ...
    private static let exercise2 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "농부", options: ["트랙터", "비행기", "잠수함", "기차"], correctAnswer: "트랙터", explanation: "농부는 트랙터를 사용하여 밭을 갑니다.")
        ]
    )
    ...
    private static let exercise14 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "친구의 하얀 카펫에 실수로 레드와인을 쏟았습니다. 어떻게 대처해야 합니까?", options: ["그 위에 의자를 놓아 얼룩을 가린다", "사과하고 즉시 오염 부위 세척을 돕는다", "아무 말 없이 파티에서 몰래 일찍 퇴장한다", "포도 주스였다고 거짓말을 한다"], correctAnswer: "사과하고 즉시 오염 부위 세척을 돕는다", explanation: "액체가 섬유에 고착되기 전에 즉시 닦아내는 대처가 얼룩을 방지하는 최선입니다."),
