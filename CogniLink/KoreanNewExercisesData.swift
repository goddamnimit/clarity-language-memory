...
struct KoreanNewExercisesData {
    ...
    private static let exercise6 = Exercise(
        ...
        difficulty: .medium,
        items: [
            ExerciseItem(prompt: "마리아는 우유와 식빵을 사러 식료품점에 갔습니다. 그런데 부엌 조리대 위에 지갑을 두고 나왔습니다. 마리아가 집에 두고 온 것은 무엇인가요?", options: ["지갑", "열쇠", "장보기 목록", "휴대전화"], correctAnswer: "지갑", explanation: "이야기에서 마리아는 지갑을 부엌 조리대 위에 두고 나왔다고 했습니다."),
            ExerciseItem(prompt: "토마스는 토요일 아침 일찍 낚시를 하러 갔습니다. 커다란 송어를 한 마리 잡았지만 너무 작아서 풀어주어야 했습니다. 토마스가 잡은 물고기는 무엇인가요?", options: ["송어", "연어", "농어", "메기"], correctAnswer: "송어", explanation: "이야기에서 잡은 물고기는 송어였습니다."),
            ExerciseItem(prompt: "아더는 그늘진 떡갈나무 아래에 자신의 파란색 차를 주차했습니다. 나중에 돌아와 보니 차가 노란 나뭇잎으로 뒤덮여 있었습니다. 아더의 차는 무슨 색인가요?", options: ["파란색", "노란색", "빨간색", "초록색"], correctAnswer: "파란색", explanation: "아더는 파란색 차를 주차했다고 이야기했습니다."),
            ExerciseItem(prompt: "린다는 딸의 생일 파티를 위해 초콜릿 케이크를 만들었습니다. 그리고 케이크 위에 빨간 초 10개를 꽂았습니다. 케이크 위에 꽂힌 초는 몇 개인가요?", options: ["10개", "5개", "8개", "12개"], correctAnswer: "10개", explanation: "케이크 위에 빨간 초 10개를 꽂았다고 했습니다."),
            ExerciseItem(prompt: "로버트는 시카고에 사는 형에게 소포를 보내기 위해 우체국에 갔습니다. 직원은 화요일에 도착할 것이라고 말했습니다. 로버트의 형은 어디에 사나요?", options: ["시카고", "뉴욕", "보스턴", "마이애미"], correctAnswer: "시카고", explanation: "형이 시카고에 산다고 했습니다."),
            ExerciseItem(prompt: "사라는 어제 새 러닝화를 샀습니다. 그 신발은 밝은 초록색 바탕에 하얀 줄무늬가 있습니다. 사라의 새 러닝화는 무슨 색인가요?", options: ["밝은 초록색", "파란색", "빨간색", "검은색"], correctAnswer: "밝은 초록색", explanation: "신발이 하얀 줄무늬가 있는 밝은 초록색이라고 언급되었습니다."),
            ExerciseItem(prompt: "제임스는 공원을 걷다가 비를 만났습니다. 그는 비를 피하기 위해 노란 우산을 폈습니다. 제임스가 사용한 우산은 무슨 색이었나요?", options: ["노란색", "빨간색", "파란색", "검은색"], correctAnswer: "노란색", explanation: "노란 우산을 폈다고 이야기했습니다."),
            ExerciseItem(prompt: "동네 빵집이 수리를 위해 월요일에 문을 닫았습니다. 그들은 화요일 아침 6시에 다시 문을 열 예정입니다. 빵집이 문을 닫은 요일은 언제인가요?", options: ["월요일", "화요일", "수요일", "일요일"], correctAnswer: "월요일", explanation: "빵집은 월요일에 문을 닫았습니다."),
            ExerciseItem(prompt: "안나는 부엌 싱크대에서 물이 새어 배관공을 불렀습니다. 배관공은 한 시간 뒤에 도착하여 파이프를 고쳤습니다. 안나가 배관공을 부른 이유는 무엇인가요?", options: ["싱크대 물이 새서", "가스레인지가 고장 나서", "전등이 꺼져서", "문이 잠겨서"], correctAnswer: "싱크대 물이 새서", explanation: "부엌 싱크대에서 물이 새서 배관공을 불렀다고 했습니다."),
            ExerciseItem(prompt: "데이비드는 반려견 맥스와 동네 한 바퀴를 돌며 산책했습니다. 맥스는 다람쥐를 보고 크게 짖었습니다. 데이비드의 반려견 이름은 무엇인가요?", options: ["맥스", "버디", "찰리", "록키"], correctAnswer: "맥스", explanation: "반려견의 이름은 맥스입니다."),
            ExerciseItem(prompt: "헬렌은 저녁으로 야채수프를 만들고 있었습니다. 당근이 떨어진 것을 알고 대신 감자를 넣었습니다. 헬렌에게 부족했던 재료는 무엇인가요?", options: ["당근", "감자", "양파", "셀러리"], correctAnswer: "당근", explanation: "당근이 다 떨어져서 감자를 사용했다고 언급되었습니다."),
            ExerciseItem(prompt: "피터는 점심으로 페퍼로니 피자 한 판과 탄산음료 한 병을 주문했습니다. 총 금액은 15달러였습니다. 피터의 점심 식사 비용은 얼마였나요?", options: ["15달러", "10달러", "20달러", "12달러"], correctAnswer: "15달러", explanation: "점심 식사의 총 비용은 15달러였습니다."),
            ExerciseItem(prompt: "앨리스는 정원 가꾸기에 관한 책을 빌리러 도서관에 갔습니다. 역사에 관한 DVD도 함께 빌렸습니다. 앨리스가 빌린 책의 주제는 무엇인가요?", options: ["정원 가꾸기", "역사", "요리", "여행"], correctAnswer: "정원 가꾸기", explanation: "정원 가꾸기에 관한 책을 빌렸다고 했습니다."),
            ExerciseItem(prompt: "조지는 아침 기차를 타고 면접을 보러 도심으로 향했습니다. 그의 기차는 철로 보수 작업으로 인해 15분 지연되었습니다. 기차가 지연된 원인은 무엇인가요?", options: ["철로 보수 작업", "폭설", "정전", "승무원 결원"], correctAnswer: "철로 보수 작업", explanation: "철로 보수 작업으로 인해 기차가 지연되었다고 언급되었습니다."),
            ExerciseItem(prompt: "낸시는 정원 센터에 가서 빨간 장미를 사려고 했습니다. 장미가 품절되어 대신 분홍색 카네이션을 샀습니다. 낸시가 결국 산 꽃은 무엇인가요?", options: ["분홍색 카네이션", "빨간 장미", "노란 튤립", "백합"], correctAnswer: "분홍색 카네이션", explanation: "장미 대신 분홍색 카네이션을 샀다고 했습니다.")
        ]
    )
