...
struct PortugueseNewExercisesData {
    ...
    private static let exercise6 = Exercise(
        ...
        difficulty: .medium,
        items: [
            ExerciseItem(prompt: "Maria foi ao supermercado comprar leite e pão. Ela esqueceu a carteira no balcão da cozinha. O que Maria deixou em casa?", options: ["A carteira", "As chaves", "A lista de compras", "O telefone"], correctAnswer: "A carteira", explanation: "A história afirma que ela esqueceu a carteira no balcão da cozinha."),
            ExerciseItem(prompt: "Tomás acordou cedo no sábado para pescar. Ele pegou uma truta grande, mas teve que devolvê-la porque era muito pequena. Que tipo de peixe Tomás pescou?", options: ["Uma truta", "Um salmão", "Um robalo", "Um bagre"], correctAnswer: "Uma truta", explanation: "A história afirma que ele pegou uma truta."),
            ExerciseItem(prompt: "Arthur estacionou seu carro azul sob a sombra de uma grande árvore. Quando voltou, viu que o carro estava coberto de folhas amarelas. Qual é a cor do carro de Arthur?", options: ["Azul", "Amarelo", "Vermelho", "Verde"], correctAnswer: "Azul", explanation: "A história afirma que Arthur estacionou seu carro azul."),
            ExerciseItem(prompt: "Linda assou um bolo de chocolate para a festa de aniversário de sua filha. Ela colocou dez velas vermelhas no bolo. Quantas velas Linda colocou no bolo?", options: ["Dez", "Cinco", "Oito", "Doze"], correctAnswer: "Dez", explanation: "A história afirma que ela colocou dez velas vermelhas no bolo."),
            ExerciseItem(prompt: "Roberto foi aos correios enviar um pacote para seu irmão em Chicago. O atendente disse que chegaria na terça-feira. Onde mora o irmão de Roberto?", options: ["Chicago", "Nova York", "Boston", "Miami"], correctAnswer: "Chicago", explanation: "A história afirma que ele enviou um pacote para seu irmão em Chicago."),
            ExerciseItem(prompt: "Sarah comprou um novo par de tênis de corrida ontem. Eles são verdes brilhantes com listras brancas. Qual é a cor dos novos tênis de corrida de Sarah?", options: ["Verde brilhante", "Azul", "Vermelho", "Preto"], correctAnswer: "Verde brilhante", explanation: "A história diz que os tênis são verdes brilhantes com listras brancas."),
            ExerciseItem(prompt: "Tiago estava caminhando no parque quando começou a chover. Ele abriu seu guarda-chuva amarelo para se manter seco. Qual era a cor do guarda-chuva que Tiago usou?", options: ["Amarelo", "Vermelho", "Azul", "Preto"], correctAnswer: "Amarelo", explanation: "A história diz que ele abriu seu guarda-chuva amarelo."),
            ExerciseItem(prompt: "A padaria local fechou na segunda-feira para reformas. Eles planejavam reabrir na terça-feira de manhã às seis horas. Em qual dia a padaria estava fechada?", options: ["Segunda-feira", "Terça-feira", "Quarta-feira", "Domingo"], correctAnswer: "Segunda-feira", explanation: "A história diz que a padaria estava fechada na segunda-feira."),
            ExerciseItem(prompt: "Ana ligou para um encanador porque a pia da cozinha estava vazando. O encanador chegou em uma hora e consertou o cano. Por que Ana ligou para um encanador?", options: ["A pia estava vazando", "O fogão estava quebrado", "A luz acabou", "A porta estava trancada"], correctAnswer: "A pia estava vazando", explanation: "A história diz que ela ligou para um encanador porque a pia da cozinha estava vazando."),
            ExerciseItem(prompt: "David passeou com seu cachorro, Max, pelo quarteirão. Max viu um esquilo e latiu alto para ele. Qual é o nome do cachorro de David?", options: ["Max", "Buddy", "Charlie", "Rocky"], correctAnswer: "Max", explanation: "A história afirma que David passeou com seu cachorro, Max."),
            ExerciseItem(prompt: "Helena estava fazendo sopa de legumes para o jantar. Ela percebeu que estava sem cenouras, então usou batatas no lugar. Qual ingrediente Helena acabou não tendo?", options: ["Cenouras", "Batatas", "Cebolas", "Aipo"], correctAnswer: "Cenouras", explanation: "A história afirma que ela percebeu que estava sem cenouras."),
            ExerciseItem(prompt: "Pedro pediu uma pizza de calabresa e uma garrafa de refrigerante para o almoço. O custo total foi de quinze reais. Quanto custou o almoço de Pedro?", options: ["Quinze reais", "Dez reais", "Vinte reais", "Doze reais"], correctAnswer: "Quinze reais", explanation: "A história afirma que o custo total foi de quinze reais."),
            ExerciseItem(prompt: "Alice foi à biblioteca para pegar emprestado um livro sobre jardinagem. Ela também pegou um DVD sobre história. Qual era o assunto do livro que Alice pegou emprestado?", options: ["Jardinagem", "História", "Culinária", "Viagem"], correctAnswer: "Jardinagem", explanation: "A história afirma que ela pegou emprestado um livro sobre jardinagem."),
            ExerciseItem(prompt: "Jorge pegou um trem matinal para a cidade para uma entrevista de emprego. Seu trem atrasou quinze minutos devido à manutenção nos trilhos. Por que o trem atrasou?", options: ["Manutenção nos trilhos", "Uma tempestade forte", "Falta de energia", "Ausência de um tripulante"], correctAnswer: "Manutenção nos trilhos", explanation: "A história afirma que o trem atrasou devido à manutenção nos trilhos."),
            ExerciseItem(prompt: "Nancy foi à floricultura comprar rosas vermelhas. Elas estavam esgotadas, então ela comprou cravos rosa. Qual flor Nancy acabou comprando?", options: ["Cravos rosa", "Rosas vermelhas", "Tulipas amarelas", "Lírios brancos"], correctAnswer: "Cravos rosa", explanation: "A história afirma que ela comprou cravos rosa no lugar.")
        ]
    )
