...
struct FarsiNewExercisesData {
    ...
    private static let exercise6 = Exercise(
        ...
        difficulty: .medium,
        items: [
            ExerciseItem(prompt: "ماریا به خواربارفروشی رفت تا شیر و نان بخرد. او کیف پول خود را روی پیشخوان آشپزخانه جا گذاشت. ماریا چه چیزی را در خانه فراموش کرده بود؟", options: ["کیف پولش", "کلیدهایش", "لیست خریدش", "تلفن همراهش"], correctAnswer: "کیف پولش", explanation: "داستان می‌گوید او کیف پول خود را روی پیشخوان آشپزخانه جا گذاشت."),
            ExerciseItem(prompt: "توماس صبح زود شنبه بیدار شد تا به ماهیگیری برود. او یک قزل‌آلای بزرگ گرفت اما مجبور شد آن را رها کند چون خیلی کوچک بود. توماس چه نوع ماهی‌ای گرفت؟", options: ["قزل‌آلا", "سالمون", "کپور", "گربه‌ماهی"], correctAnswer: "قزل‌آلا", explanation: "داستان اشاره می‌کند که او یک ماهی قزل‌آلا گرفت."),
            ExerciseItem(prompt: "آرتور ماشین آبی خود را زیر سایه درخت بلوط پارک کرد. وقتی برگشت، دید که ماشین با برگ‌های زرد پوشیده شده است. ماشین آرتور چه رنگی است؟", options: ["آبی", "زرد", "قرمز", "سبز"], correctAnswer: "آبی", explanation: "داستان می‌گوید آرتور ماشین آبی خود را پارک کرد."),
            ExerciseItem(prompt: "لیندا برای جشن تولد دخترش یک کیک شکلاتی پخت. او ده شمع قرمز روی کیک گذاشت. لیندا چند شمع روی کیک گذاشت؟", options: ["ده", "پنج", "هشت", "دوازده"], correctAnswer: "ده", explanation: "داستان می‌گوید او ده شمع قرمز روی کیک گذاشت."),
            ExerciseItem(prompt: "رابرت به اداره پست رفت تا بسته‌ای را برای برادرش در شیکاگو ارسال کند. متصدی گفت بسته روز سه‌شنبه می‌رسد. برادر رابرت کجا زندگی می‌کند؟", options: ["شیکاگو", "نیویورک", "بوستون", "میامی"], correctAnswer: "شیکاگو", explanation: "داستان می‌گوید او بسته را برای برادرش در شیکاگو فرستاد."),
            ExerciseItem(prompt: "سارا دیروز یک جفت کفش دویدن خرید. آن‌ها سبز روشن با خطوط سفید هستند. کفش‌های سارا چه رنگی هستند؟", options: ["سبز روشن", "آبی", "قرمز", "مشکی"], correctAnswer: "سبز روشن", explanation: "داستان می‌گوید کفش‌ها سبز روشن با خطوط سفید هستند."),
            ExerciseItem(prompt: "جیمز در پارک قدم می‌زد که باران شروع شد. او چتر زرد خود را باز کرد تا خشک بماند. چتر جیمز چه رنگی بود؟", options: ["زرد", "قرمز", "آبی", "مشکی"], correctAnswer: "زرد", explanation: "داستان می‌گوید او چتر زرد خود را باز کرد."),
            ExerciseItem(prompt: "نانوایی محلی روز دوشنبه برای تعمیرات بسته بود. آن‌ها قصد داشتند روز سه‌شنبه ساعت شش صبح بازگشایی کنند. نانوایی چه روزی بسته بود؟", options: ["دوشنبه", "سه‌شنبه", "چهارشنبه", "یکشنبه"], correctAnswer: "دوشنبه", explanation: "داستان می‌گوید نانوایی روز دوشنبه بسته بود."),
            ExerciseItem(prompt: "آنا با لوله‌کش تماس گرفت زیرا سینک آشپزخانه‌اش نشتی داشت. لوله‌کش یک ساعته رسید و لوله را تعمیر کرد. چرا آنا با لوله‌کش تماس گرفت؟", options: ["سینکش نشتی داشت", "اجاق گازش خراب بود", "لامپش سوخته بود", "درش قفل شده بود"], correctAnswer: "سینکش نشتی داشت", explanation: "داستان می‌گوید او تماس گرفت چون سینک آشپزخانه‌اش نشتی داشت."),
            ExerciseItem(prompt: "دیوید سگش، مکس، را به دور محله برد. مکس یک سنجاب دید و با صدای بلند پارس کرد. نام سگ دیوید چیست؟", options: ["مکس", "بادی", "چارلی", "راکی"], correctAnswer: "مکس", explanation: "داستان می‌گوید دیوید سگش، مکس، را پیاده‌روی برد."),
            ExerciseItem(prompt: "هلن در حال درست کردن سوپ سبزیجات برای شام بود. او متوجه شد که هویج ندارد، بنابراین به جای آن از سیب‌زمینی استفاده کرد. هلن کدام ماده غذایی را تمام کرده بود؟", options: ["هویج", "سیب‌زمینی", "پیاز", "کرفس"], correctAnswer: "هویج", explanation: "داستان می‌گوید او متوجه شد هویج ندارد."),
            ExerciseItem(prompt: "پیتر برای ناهار یک پیتزای پپرونی و یک بطری نوشابه سفارش داد. هزینه کل پانزده دلار شد. ناهار پیتر چقدر هزینه داشت؟", options: ["پانزده دلار", "ده دلار", "بیست دلار", "دوازده دلار"], correctAnswer: "پانزده دلار", explanation: "داستان می‌گوید هزینه کل پانزده دلار شد."),
            ExerciseItem(prompt: "آلیس به کتابخانه رفت تا کتابی درباره باغبانی امانت بگیرد. او همچنین یک دی‌وی‌دی درباره تاریخ امانت گرفت. موضوع کتاب آلیس چه بود؟", options: ["باغبانی", "تاریخ", "آشپزی", "سفر"], correctAnswer: "باغبانی", explanation: "داستان می‌گوید او کتابی درباره باغبانی امانت گرفت."),
            ExerciseItem(prompt: "جورج با قطار صبحگاهی برای مصاحبه کاری به شهر رفت. قطار او به دلیل تعمیرات ریل پانزده دقیقه تأخیر داشت. چرا قطار تأخیر داشت؟", options: ["تعمیرات ریل", "طوفان شدید", "قطعی برق", "کمبود پرسنل"], correctAnswer: "تعمیرات ریل", explanation: "داستان می‌گوید قطار به دلیل تعمیرات ریل تأخیر داشت."),
            ExerciseItem(prompt: "نانسی به گل‌فروشی رفت تا رز قرمز بخرد. آن‌ها رز نداشتند، بنابراین او گل قرنفل صورتی خرید. نانسی در نهایت چه گلی خرید؟", options: ["قرنفل صورتی", "رز قرمز", "لاله زرد", "زنبق سفید"], correctAnswer: "قرنفل صورتی", explanation: "داستان می‌گوید او گل قرنفل صورتی خرید.")
        ]
    )
