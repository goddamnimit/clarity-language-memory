...
struct FarsiCognitionExerciseData {
    ...
    private static let historyKnowledge = Exercise(
        ...
        difficulty: .medium,
        items: [
            ExerciseItem(id: UUID(), prompt: "انقلاب فرانسه در چه سالی آغاز شد؟", options: ["۱۷۷۶", "۱۷۸۹", "۱۸۰۴", "۱۸۱۵"], correctAnswer: "۱۷۸۹"),
            ExerciseItem(id: UUID(), prompt: "کشتی تایتانیک چه سالی غرق شد؟", options: ["۱۹۰۱", "۱۹۱۲", "۱۹۱۸", "۱۹۳۵"], correctAnswer: "۱۹۱۲"),
            ExerciseItem(id: UUID(), prompt: "امپراتوری روم غربی در چه سالی سقوط کرد؟", options: ["۲۹۶ میلادی", "۳۷۶ میلادی", "۴۷۶ میلادی", "۵۷۶ میلادی"], correctAnswer: "۴۷۶ میلادی"),
            ...
            ExerciseItem(id: UUID(), prompt: "جنگ سرد عمدتاً بین کدام دو کشور بود؟", options: ["آمریکا و شوروی", "آمریکا و چین", "فرانسه و آلمان", "انگلستان و روسیه"], correctAnswer: "آمریکا و شوروی"),
            ExerciseItem(id: UUID(), prompt: "رضاشاه بنیانگذار کدام سلسله پادشاهی ایران بود؟", options: ["قاجار", "صفوی", "پهلوی", "افشاریه"], correctAnswer: "پهلوی"),
            ...
            ExerciseItem(id: UUID(), prompt: "جنگ ایران و عراق چه سال‌هایی بود؟", options: ["۱۹۷۵ تا ۱۹۸۰", "۱۹۸۰ تا ۱۹۸۸", "۱۹۸۸ تا ۱۹۹۵", "۱۹۹۰ تا ۱۹۹۸"], correctAnswer: "۱۹۸۰ تا ۱۹۸۸"),
            ExerciseItem(id: UUID(), prompt: "آمریکا در چه سالی اعلام استقلال کرد؟", options: ["۱۶۲۰", "۱۷۷۶", "۱۷۸۹", "۱۸۰۰"], correctAnswer: "۱۷۷۶"),
    ...
    private static let locationsKnowledge = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "برج میلاد کجاست؟", options: ["اصفهان", "مشهد", "تهران", "شیراز"], correctAnswer: "تهران"),
            ExerciseItem(id: UUID(), prompt: "پل خواجو کجاست؟", options: ["تهران", "مشهد", "شیراز", "اصفهان"], correctAnswer: "اصفهان"),
            ExerciseItem(id: UUID(), prompt: "آرامگاه حافظ کجاست؟", options: ["تهران", "اصفهان", "شیراز", "مشهد"], correctAnswer: "شیراز"),
            ExerciseItem(id: UUID(), prompt: "قلعه الموت کجاست؟", options: ["تهران", "اصفهان", "شیراز", "قزوین"], correctAnswer: "قزوین"),
            ...
            ExerciseItem(id: UUID(), prompt: "استون‌هنج کجاست؟", options: ["فرانسه", "ایرلند", "اسکاتلند", "انگلستان"], correctAnswer: "انگلستان"),
            ExerciseItem(id: UUID(), prompt: "مجسمه مسیح رهاننده کجاست؟", options: ["آرژانتین", "شیلی", "پرتغال", "ریودوژانیرو، برزیل"], correctAnswer: "ریودوژانیرو، برزیل"),
            ExerciseItem(id: UUID(), prompt: "اهرام ثلاثه کجا هستند؟", options: ["مراکش", "سودان", "لیبی", "مصر"], correctAnswer: "مصر"),
            ExerciseItem(id: UUID(), prompt: "برج کج پیزا کجاست؟", options: ["آتن، یونان", "مادرید، اسپانیا", "استانبول، ترکیه", "پیزا، ایتالیا"], correctAnswer: "پیزا، ایتالیا"),
    ...
    private static let estimationLogic = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "آب در سطح دریا در چند درجه سانتیگراد به جوش می‌آید؟", options: ["۵۰", "۷۵", "۱۰۰", "۱۵۰"], correctAnswer: "۱۰۰"),
            ...
            ExerciseItem(id: UUID(), prompt: "نور خورشید تقریباً چند دقیقه طول می‌کشد تا به زمین برسد؟", options: ["۱", "۸", "۳۰", "۶۰"], correctAnswer: "۸"),
            ...
            ExerciseItem(id: UUID(), prompt: "سرعت نور تقریباً چند کیلومتر در ثانیه است؟", options: ["۳۰۰", "۳٬۰۰۰", "۳۰۰٬۰۰۰", "۳٬۰۰۰٬۰۰۰"], correctAnswer: "۳۰۰٬۰۰۰"),
