...
struct GujaratiNewExercisesData {
    ...
    private static let exercise6 = Exercise(
        ...
        difficulty: .medium,
        items: [
            ExerciseItem(prompt: "મારિયા દૂધ અને બ્રેડ ખરીદવા કરિયાણાની દુકાને ગઈ. તે પોતાનું પાકીટ રસોડાના પ્લેટફોર્મ પર ભૂલી ગઈ. મારિયા ઘરે શું ભૂલી ગઈ હતી?", options: ["તેનું પાકીટ", "તેની ચાવીઓ", "તેની ખરીદીની યાદી", "તેનો ફોન"], correctAnswer: "તેનું પાકીટ", explanation: "વાર્તામાં સ્પષ્ટ લખ્યું છે કે તે પોતાનું પાકીટ રસોડાના પ્લેટફોર્મ પર ભૂલી ગઈ હતી."),
            ExerciseItem(prompt: "થોમસ શનિવારે સવારે વહેલો જાગીને માછલી પકડવા ગયો. તેણે એક મોટી ટ્રાઉટ માછલી પકડી પણ તે બહુ નાની હોવાથી તેણે પાણીમાં પાછી છોડવી પડી. થોમસે કઈ માછલી પકડી હતી?", options: ["ટ્રાઉટ", "સાલ્મન", "બાસ", "કેટફિશ"], correctAnswer: "ટ્રાઉટ", explanation: "વાર્તામાં જણાવ્યું છે કે તેણે એક મોટી ટ્રાઉટ માછલી પકડી હતી."),
            ExerciseItem(prompt: "આર્થરે તેની વાદળી કાર એક છાંયડાવાળા વૃક્ષ નીચે પાર્ક કરી. જ્યારે તે પાછો આવ્યો, ત્યારે તેણે જોયું કે કાર પીળા પાંદડાઓથી ઢંકાયેલી હતી. આર્થરની કાર કયા રંગની છે?", options: ["વાદળી", "પીળો", "લાલ", "લીલો"], correctAnswer: "વાદળી", explanation: "વાર્તા અનુસાર આર્થરે તેની વાદળી કાર પાર્ક કરી હતી."),
            ExerciseItem(prompt: "લિન્ડાએ તેની પુત્રીના જન્મદિવસની પાર્ટી માટે ચોકલેટ કેક બનાવી. તેણે કેક પર દસ લાલ મીણબત્તીઓ લગાવી. લિન્ડાએ કેક પર કેટલી મીણબત્તીઓ લગાવી?", options: ["દસ", "પાંચ", "આઠ", "બાર"], correctAnswer: "દસ", explanation: "વાર્તામાં જણાવ્યું છે કે તેણે દસ લાલ મીણબત્તીઓ લગાવી હતી."),
            ExerciseItem(prompt: "રોબર્ટ શિકાગોમાં રહેતા તેના ભાઈને પાર્સલ મોકલવા પોસ્ટ ઓફિસ ગયો. ક્લર્કે તેને કહ્યું કે તે મંગળવારે પહોંચશે. રોબર્ટનો ભાઈ ક્યાં રહે છે?", options: ["શિકાગો", "ન્યૂયોર્ક", "બોસ્ટન", "માયામી"], correctAnswer: "શિકાગો", explanation: "વાર્તામાં સ્પષ્ટ છે કે તેણે શિકાગોમાં રહેતા તેના ભાઈને પાર્સલ મોકલ્યું હતું."),
            ExerciseItem(prompt: "સારાએ ગઈકાલે દોડવા માટે નવા શૂઝ ખરીદ્યા. તે સફેદ પટ્ટાવાળા ચમકતા લીલા રંગના છે. સારાના દોડવાના શૂઝ કયા રંગના છે?", options: ["ચમકતો લીલો", "વાદળી", "લાલ", "કાળો"], correctAnswer: "ચમકતો લીલો", explanation: "વાર્તા અનુસાર શૂઝ સફેદ પટ્ટાવાળા ચમકતા લીલા રંગના છે."),
            ExerciseItem(prompt: "જેમ્સ બગીચામાં ટહેલી રહ્યો હતો ત્યારે અચાનક વરસાદ શરૂ થયો. સૂકા રહેવા માટે તેણે પોતાની પીળી છત્રી ખોલી. જેમ્સે કયા રંગની છત્રી વાપરી હતી?", options: ["પીળી", "લાલ", "વાદળી", "કાળી"], correctAnswer: "પીળી", explanation: "વાર્તા જણાવે છે કે તેણે પોતાની પીળી છત્રી ખોલી હતી."),
            ExerciseItem(prompt: "સ્થાનિક બેકરી સમારકામ માટે સોમવારે બંધ હતી. તેઓએ મંગળવારે સવારે છ વાગ્યે ફરીથી ખોલવાનું આયોજન કર્યું હતું. બેકરી કયા દિવસે બંધ હતી?", options: ["સોમવાર", "મંગળવાર", "બુધવાર", "રવિવાર"], correctAnswer: "સોમવાર", explanation: "વાર્તા અનુસાર બેકરી સોમવારે બંધ હતી."),
            ExerciseItem(prompt: "અન્નાએ પ્લમ્બરને બોલાવ્યો કારણ કે તેના રસોડાની સિંક લીક થતી હતી. પ્લમ્બર એક કલાકમાં આવ્યો અને પાઇપ સમી કરી દીધી. અન્નાએ પ્લમ્બરને શા માટે બોલાવ્યો હતો?", options: ["તેની સિંક લીક થતી હતી", "તેનો ચૂલો બગડેલો હતો", "તેની લાઈટ જતી રહી હતી", "તેનો દરવાજો લોક હતો"], correctAnswer: "તેની સિંક લીક થતી હતી", explanation: "વાર્તા મુજબ તેણે પ્લમ્બરને રસોડાની સિંક લીક થતી હોવાને લીધે બોલાવ્યો હતો."),
            ExerciseItem(prompt: "ડેવિડે તેના કૂતરા મેક્સને ફેરવ્યો. મેક્સે એક ખિસકોલી જોઈ અને તેના પર જોરથી ભસ્યો. ડેવિડના કૂતરાનું નામ શું છે?", options: ["મેક્સ", "બડી", "ચાર્લી", "રોકી"], correctAnswer: "મેક્સ", explanation: "વાર્તામાં ડેવિડના કૂતરાનું નામ મેક્સ હોવાનું જણાવ્યું છે."),
            ExerciseItem(prompt: "હેલન રાત્રિના ભોજન માટે શાકભાજીનો સૂપ બનાવી રહી હતી. તેને ખબર પડી કે તેની ગાજર ખૂટી ગઈ છે, તેથી તેણે બટાકા વાપર્યા. હેલન પાસે કયું શાક ખૂટી ગયું હતું?", options: ["ગાજર", "બટાકા", "ડુંગળી", "કોથમીર"], correctAnswer: "ગાજર", explanation: "વાર્તા જણાવે છે કે રાંધતી વખતે તેને ખબર પડી કે ગાજર ખૂટી ગયા છે."),
            ExerciseItem(prompt: "પીટરે બપોરના ભોજન માટે એક પેપરોની પિઝા અને સોડા ઓર્ડર કર્યો. કુલ બિલ પંદર ડોલર હતું. પીટરના ભોજનનું બિલ કેટલું હતું?", options: ["પંદર ડોલર", "દસ ડોલર", "વીસ ડોલર", "બાર ડોલર"], correctAnswer: "પંદર ડોલર", explanation: "વાર્તામાં સ્પષ્ટ જણાવ્યું છે કે કુલ ખર્ચ પંદર ડોલર હતું."),
            ExerciseItem(prompt: "એલિસ બાગાયત વિશે પુસ્તક લેવા લાઇબ્રેરી ગઈ. તેણે ઇતિહાસની ડીવીડી પણ લીધી. એલિસે લીધેલું પુસ્તક કયા વિષય પર હતું?", options: ["બાગાયત", "ઇતિહાસ", "રસોઈ", "પ્રવાસ"], correctAnswer: "બાગાયત", explanation: "વાર્તામાં જણાવ્યું છે કે તે બાગાયત વિશેનું પુસ્તક લેવા ગઈ હતી."),
            ExerciseItem(prompt: "જ્યોર્જ નોકરીના ઇન્ટરવ્યુ માટે સવારની ટ્રેન દ્વારા શહેરમાં ગયો. રેલ્વે ટ્રેકના સમારકામને કારણે ટ્રેન પંદર મિનિટ મોડી ચાલી રહી હતી. ટ્રેન મોડી થવાનું કારણ શું હતું?", options: ["ટ્રેકનું સમારકામ", "ભારે તોફાન", "પાવર કટ", "કર્મચારીની ગેરહાજરી"], correctAnswer: "ટ્રેકનું સમારકામ", explanation: "વાર્તા મુજબ ટ્રેક રિપેરિંગની કામગીરીને કારણે ટ્રેન મોડી પડી હતી."),
            ExerciseItem(prompt: "네ન્સી લાલ ગુલાબ ખરીદવા નર્સરી ગઈ. ગુલાબ ખલાસ થઈ ગયા હતા, તેથી તેણે ગુલાબી કાર્નેશન ખરીદ્યા. નેન્સીએ કયું ફૂલ ખરીદ્યું?", options: ["ગુલાબી કાર્નેશન", "લાલ ગુલાબ", "પીળા ટ્યૂલિપ", "સફેદ લીલી"], correctAnswer: "ગુલાબી કાર્નેશન", explanation: "વાર્તામાં જણાવ્યું છે કે તેણે ગુલાબી કાર્નેશન ખરીદ્યા.")
        ]
    )
