...
struct KoreanCognitionExerciseData {
    ...
    private static let figurativeLanguageIdioms = Exercise(
        ...
        items: [
            ...
            ExerciseItem(
                ...
                options: ["기분이 아주 좋고 만족스럽다", "조용히 노래를 연습하다", "코에 병이 나서 콧소리를 내다", "남의 말을 무시하고 흥얼거리다"],
            ...
            ExerciseItem(
                ...
                options: ["해결책을 얻기 위해 머리를 써서 꾀를 내다", "몸을 공처럼 둥글게 말아 구르다", "생각 없이 충동적으로 행동하다", "잠을 자기 위해 베개를 조정하다"],
            ...
            ExerciseItem(
                ...
                options: ["어떤 일이 진행되지 못하도록 방해하다", "넘어지려는 사람의 발을 붙잡다", "남의 약점을 잡아 협박하다", "신발 끈을 단단히 묶다"],
    ...
    private static let storyRecall = Exercise(
        ...
        items: [
            ...
            ExerciseItem(
                id: UUID(),
                prompt: "김영희 씨는 LA 한인타운에 있는 한남체인에서 갈비용 소고기와 무를 샀습니다. 그녀는 계산을 하려다 바지 주머니에 지갑을 두고 차에 가방을 놔둔 것을 알았습니다. 김영희 씨가 한남체인에서 산 고기는 어떤 종류인가요?",
                options: ["갈비용 소고기", "불고기용 돼지고기", "닭볶음탕용 닭고기", "국거리용 소고기"],
                correctAnswer: "갈비용 소고기",
                explanation: "이야기에서 김영희 씨는 한남체인에서 갈비용 소고기와 무를 샀다고 명시되어 있습니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "박준서 할아버지는 토요일 아침 올림픽 경찰서 근처 공원에서 오랜 친구인 이철수 씨를 만나 바둑을 두기로 했습니다. 그러나 이철수 씨는 약속 시간을 착각해 30분 늦게 도착했습니다. 박준서 할아버지는 친구와 공원에서 무엇을 두기로 했습니까?",
                options: ["바둑", "장기", "체스", "화투"],
                correctAnswer: "바둑",
                explanation: "이야기에서 두 사람은 공원에서 바둑을 두기로 약속했습니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "정민우 씨는 로스앤젤레스에서 샌프란시스코로 가는 5번 고속도로를 달리고 있었습니다. 도중에 타이어에 못이 박혀 베이커스필드 근처 정비소에서 타이어를 교체해야 했습니다. 정민우 씨는 어떤 도시 근처에서 정비소에 들렀습니까?",
                options: ["베이커스필드", "로스앤젤레스", "샌프란시스코", "새크라멘토"],
                correctAnswer: "베이커스필드",
                explanation: "정민우 씨는 베이커스필드 근처 정비소에서 타이어를 교체했다고 이야기되어 있습니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "최은지 씨는 아버님의 칠순 잔치를 위해 LA의 유명한 한국 떡집에서 시루떡과 무지개떡을 주문했습니다. 잔치는 일요일 오후 5시에 시작될 예정이었습니다. 최은지 씨는 떡집에서 어떤 종류의 떡들을 주문했습니까?",
                options: ["시루떡과 무지개떡", "인절미와 송편", "백설기와 꿀떡", "찹쌀떡과 바람떡"],
                correctAnswer: "시루떡과 무지개떡",
                explanation: "이야기에서 최은지 씨가 주문한 떡은 시루떡과 무지개떡입니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "이영수 씨는 주말에 오렌지 카운티에 사는 손녀 지민이에게 줄 생일 선물로 은색 목걸이를 샀습니다. 지민이의 아홉 번째 생일을 축하하기 위한 선물이었습니다. 지민이의 생일 선물은 무엇입니까?",
                options: ["은색 목걸이", "금반지", "인형 유모차", "그림책 세트"],
                correctAnswer: "은색 목걸이",
                explanation: "이영수 씨는 손녀 지민이의 선물로 은색 목걸이를 샀다고 언급되어 있습니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "김지수 씨는 아침 8시에 세탁소에 들러 남편의 양복과 겨울 코트를 맡겼습니다. 세탁소 사장님은 목요일 오후 4시 이후에 찾으러 오라고 하셨습니다. 양복은 몇 시 이후에 찾을 수 있습니까?",
                options: ["목요일 오후 4시", "수요일 오전 8시", "목요일 오전 8시", "금요일 오후 4시"],
                correctAnswer: "목요일 오후 4시",
                explanation: "세탁소 사장님이 목요일 오후 4시 이후에 찾으러 오라고 안내하셨습니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "박민재 군은 그리피스 천문대에서 열리는 천체 관측 행사에 참가하기로 했습니다. 금요일 밤 9시에 시작하는 행사였지만, 갑자기 안개가 짙어져 토요일로 연기되었습니다. 원래 행사가 시작되기로 한 요일과 시간은 언제입니까?",
                options: ["금요일 밤 9시", "토요일 밤 9시", "금요일 저녁 7시", "일요일 밤 9시"],
                correctAnswer: "금요일 밤 9시",
                explanation: "원래 행사는 금요일 밤 9시에 시작하기로 예정되어 있었습니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "정경숙 할머니는 매일 아침 라디오 코리아의 뉴스 프로그램을 듣습니다. 오늘 아침 뉴스에서는 이번 주말 LA 지역에 평년보다 기온이 높을 것이라고 보도했습니다. 정경숙 할머니가 들으신 보도는 무엇에 관한 것이었습니까?",
                options: ["주말 높은 기온 예보", "폭우 대비 요령", "한인타운 도로 통제", "라디오 주파수 변경"],
                correctAnswer: "주말 높은 기온 예보",
                explanation: "뉴스에서 주말 LA 지역 기온이 평년보다 높을 것이라고 보도했습니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "최성호 씨는 집 마당에 한국에서 가져온 대추나무 묘목을 심었습니다. 나무가 잘 자라도록 매주 화요일과 금요일 아침마다 물을 주었습니다. 최성호 씨는 마당에 어떤 나무를 심었습니까?",
                options: ["대추나무", "감나무", "밤나무", "소나무"],
                correctAnswer: "대추나무",
                explanation: "최성호 씨가 마당에 심은 것은 대추나무 묘목입니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "김혜원 씨는 한인 문화 센터에서 서예 교실을 신청했습니다. 매주 수요일 오후 2시부터 시작하는 강의였으며, 준비물은 붓과 벼루, 그리고 먹이었습니다. 강의를 듣기 위해 김혜원 씨가 준비해야 하는 도구는 무엇입니까?",
                options: ["붓, 벼루, 먹", "물감과 도화지", "연필과 스케치북", "서예용 모포와 먹물만"],
                correctAnswer: "붓, 벼루, 먹",
                explanation: "강의 준비물로 붓, 벼루, 먹이 명시되어 있습니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "이정훈 씨는 사촌 형의 이사를 돕기 위해 글렌데일로 향했습니다. 그는 가는 길에 베이글 가게에 들러 블루베리 베이글 6개와 크림치즈를 샀습니다. 이정훈 씨가 베이글을 사러 들른 가게에서 산 맛은 무엇입니까?",
                options: ["블루베리", "어니언", "시나몬 레이즌", "플레인"],
                correctAnswer: "블루베리",
                explanation: "이정훈 씨가 구입한 베이글은 블루베리 베이글입니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "박소희 씨는 반려견인 시츄 '초코'의 예방접종을 위해 동물병원에 예약 전화를 했습니다. 수의사는 목요일 오전 10시 30분이 비어 있다고 안내했습니다. 박소희 씨의 반려견 품종은 무엇입니까?",
                options: ["시츄", "푸들", "말티즈", "진돗개"],
                correctAnswer: "시츄",
                explanation: "박소희 씨의 반려견은 '시츄' 품종의 '초코'라고 나와 있습니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "김도윤 씨는 직장 동료의 결혼식에 참석하기 위해 다운타운 LA의 호텔 예식장으로 출발했습니다. 결혼식은 토요일 오후 1시에 시작이었으나, 프리웨이 교통 체증으로 20분 늦게 도착했습니다. 결혼식의 원래 시작 시간은 언제였습니까?",
                options: ["토요일 오후 1시", "토요일 낮 12시", "일요일 오후 1시", "토요일 오후 1시 20분"],
                correctAnswer: "토요일 오후 1시",
                explanation: "결혼식은 원래 토요일 오후 1시 시작 예정이었습니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "한미 은행에서 근무하는 정예진 씨는 점심시간에 은행 옆 분식집에서 떡볶이와 김말이 튀김을 먹었습니다. 점심값으로 총 12달러를 현금으로 지불했습니다. 정예진 씨가 점심으로 먹은 메뉴는 무엇입니까?",
                options: ["떡볶이와 김말이 튀김", "김밥과 라면", "순대와 튀김 세트", "돈가스와 우동"],
                correctAnswer: "떡볶이와 김말이 튀김",
                explanation: "정예진 씨가 분식집에서 떡볶이와 김말이 튀김을 먹었다고 되어 있습니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "최진우 씨는 아침 조깅 중에 스마트폰을 길가 잔디밭에 떨어뜨렸습니다. 다행히 액정은 깨지지 않았고, 스마트폰 뒷면에 붙여둔 빨간 스티커 덕분에 쉽게 찾을 수 있었습니다. 스마트폰을 쉽게 찾을 수 있었던 이유는 무엇입니까?",
                options: ["빨간 스티커 덕분에", "벨소리가 울려서", "지나가던 행인이 알려줘서", "GPS 추적기를 사용해서"],
                correctAnswer: "빨간 스티커 덕분에",
                explanation: "스마트폰 뒷면에 붙여둔 빨간 스티커 덕분에 쉽게 찾을 수 있었다고 기술되어 있습니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "임미숙 씨는 추석을 앞두고 가족들과 송편을 빚기 위해 쌀가루와 참깨를 준비했습니다. 그녀의 시어머니는 올해 송편 소로 밤과 팥도 준비하라고 하셨습니다. 올해 송편 소로 새롭게 준비하라고 하신 재료는 무엇입니까?",
                options: ["밤과 팥", "설탕과 꿀", "대추와 녹두", "참깨와 콩"],
                correctAnswer: "밤과 팥",
                explanation: "시어머니께서 송편 소로 밤과 팥도 함께 준비하라고 지시하셨습니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "백승현 씨는 차고 정리를 하다가 먼지가 쌓인 오래된 통기타를 발견했습니다. 고등학교 시절 밴드 동아리에서 연주하던 악기였으며, 조율을 새로 하니 여전히 좋은 소리가 났습니다. 백승현 씨가 차고에서 발견한 악기는 무엇입니까?",
                options: ["통기타", "바이올린", "플루트", "피아노"],
                correctAnswer: "통기타",
                explanation: "차고 정리를 하다가 발견한 악기는 오래된 통기타입니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "황지영 씨는 건강검진을 위해 전날 밤 9시부터 물을 포함하여 일절 금식했습니다. 다음 날 아침 8시 30분에 병원에 도착해 채혈 검사부터 진행했습니다. 황지영 씨가 금식을 시작한 시간은 언제입니까?",
                options: ["전날 밤 9시", "당일 아침 8시 30분", "전날 자정 12시", "당일 오전 6시"],
                correctAnswer: "전날 밤 9시",
                explanation: "황지영 씨는 전날 밤 9시부터 금식을 시작했다고 명시되어 있습니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "신민재 씨는 이번 일요일에 로스앤젤레스 다저스 스타디움에서 열리는 야구 경기를 직관하러 가기로 했습니다. 경기는 오후 4시 10분에 시작될 예정이며, 그는 동생과 1시간 전에 입구에서 만나기로 했습니다. 두 사람이 만나기로 한 시각은 몇 시입니까?",
                options: ["오후 3시 10분", "오후 4시 10분", "오후 3시", "오후 5시 10분"],
                correctAnswer: "오후 3시 10분",
                explanation: "경기 시작(오후 4시 10분) 1시간 전에 만나기로 했으므로 만나는 시각은 오후 3시 10분입니다."
            ),
            ExerciseItem(
                id: UUID(),
                prompt: "오현우 할아버지는 손자 시우의 첫 돌을 기념하여 금반지 한 돈을 선물했습니다. 돌잔치는 LA 한인타운의 한 한식당에서 친척 20명을 모시고 진행되었습니다. 돌잔치에 참석한 친척은 모두 몇 명입니까?",
                options: ["20명", "10명", "15명", "30명"],
                correctAnswer: "20명",
                explanation: "돌잔치는 친척 20명을 모시고 진행되었다고 나와 있습니다."
            )
