...
struct FrenchCognitionExerciseData {
    ...
    private static let exercise8 = Exercise(
        ...
        difficulty: .medium,
        items: [
            ExerciseItem(id: UUID(), prompt: "Madame Dupont est allée au marché le lundi. Elle a acheté du pain, du lait et des fruits. Qu'a-t-elle acheté?", options: ["Pain, lait et fruits", "Pain, viande et légumes", "Fruits, fromage et eau", "Lait, gâteau et café"], correctAnswer: "Pain, lait et fruits", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "Pierre est allé voir le médecin mardi matin. Il a attendu une heure. La consultation a duré 30 minutes. Combien de temps Pierre a-t-il attendu?", options: ["30 minutes", "45 minutes", "1 heure", "1 heure 30"], correctAnswer: "1 heure", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "Marie a 5 petits-enfants. Trois sont des filles et deux sont des garçons. Combien de petits-fils a-t-elle?", options: ["1", "2", "3", "5"], correctAnswer: "2", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "Le train de Lyon part à 14h30. Le voyage dure 2 heures. À quelle heure arrive-t-il à destination?", options: ["15h30", "16h00", "16h30", "17h00"], correctAnswer: "16h30", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "Jacques a acheté 3 baguettes à 1 euro chacune et 2 croissants à 1,50 euro chacun. Combien a-t-il dépensé?", options: ["5 euros", "5,50 euros", "6 euros", "6,50 euros"], correctAnswer: "6 euros", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "Sophie partait en vacances vendredi. Elle a préparé sa valise jeudi soir. De quel jour date la préparation de la valise?", options: ["Mercredi", "Jeudi", "Vendredi", "Samedi"], correctAnswer: "Jeudi", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "Le médecin a prescrit un médicament à prendre 3 fois par jour pendant 10 jours. Combien de prises y a-t-il en total?", options: ["20", "25", "30", "35"], correctAnswer: "30", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "Hélène aime lire. Elle lit en moyenne 1 livre par semaine. Combien de livres lit-elle en 1 mois (4 semaines)?", options: ["2 livres", "3 livres", "4 livres", "5 livres"], correctAnswer: "4 livres", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "Paul est né en 1940. En 2025, quel âge a-t-il?", options: ["75 ans", "80 ans", "85 ans", "90 ans"], correctAnswer: "85 ans", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "Anne a invité 8 amis pour son anniversaire. Chacun a apporté un cadeau. Elle a reçu des fleurs, un livre, des chocolats et 5 autres cadeaux. Combien de cadeaux a-t-elle reçus en tout?", options: ["6", "7", "8", "9"], correctAnswer: "8", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "Le marché a lieu chaque dimanche de 7h à 13h. À quelle heure ferme-t-il?", options: ["12h", "12h30", "13h", "14h"], correctAnswer: "13h", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "Marie-Claire a fait de la tarte aux pommes avec 6 pommes. Elle en a utilisé 4. Combien lui en reste-t-il?", options: ["1", "2", "3", "4"], correctAnswer: "2", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "Le concert commençait à 20h. Il a duré 2 heures et demie. À quelle heure s'est-il terminé?", options: ["21h30", "22h", "22h30", "23h"], correctAnswer: "22h30", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "Bernard a reçu une lettre de son neveu en Haïti. La lettre est arrivée le 15 mars. Son neveu l'avait envoyée le 8 mars. Combien de jours a pris la lettre?", options: ["5 jours", "6 jours", "7 jours", "8 jours"], correctAnswer: "7 jours", explanation: ""),
            ExerciseItem(id: UUID(), prompt: "Françoise a tricoté un pull pour sa petite-fille. Elle a utilisé de la laine bleue et blanche. De quelle couleur est la laine?", options: ["Rouge et verte", "Bleue et blanche", "Jaune et noire", "Rose et dorée"], correctAnswer: "Bleue et blanche", explanation: "")
        ]
    )
