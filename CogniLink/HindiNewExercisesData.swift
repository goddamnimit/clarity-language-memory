...
struct HindiNewExercisesData {
    ...
    private static let exercise6 = Exercise(
        ...
        items: [
            ...
            ExerciseItem(prompt: "थॉमस ने कौन सी मछली पकड़ी थी?", options: ["एक ट्राउट", "एक सैल्मन", "एक बास", "एक कैटफ़िश"], correctAnswer: "एक ट्राउट", explanation: "कहानी में कहा गया है कि उसने एक बड़ी ट्राउट पकड़ी थी।", passage: "थॉमस शनिवार को जल्दी जागकर मछली पकड़ने गया। उसने एक बड़ी ट्राउट मछली पकड़ी लेकिन उसे वापस छोड़ना पड़ा क्योंकि वह बहुत छोटी थी।"),
            ExerciseItem(prompt: "आर्थर की कार का रंग क्या है?", options: ["नीला", "पीला", "लाल", "हरा"], correctAnswer: "नीला", explanation: "कहानी बताती है कि आर्थर ने अपनी नीली कार खड़ी की थी।", passage: "आर्थर ने अपनी नीली कार एक छायादार ओक के पेड़ के नीचे खड़ी की। जब वह लौटा, तो उसने देखा कि कार पीले पत्तों से ढकी हुई थी।"),
            ExerciseItem(prompt: "लिंडा ने केक पर कितनी मोमबत्तियां लगाईं?", options: ["दस", "पांच", "आठ", "बारह"], correctAnswer: "दस", explanation: "कहानी में कहा गया है कि उसने दस लाल मोमबत्तियां लगाईं।", passage: "लिंडा ने अपनी बेटी के जन्मदिन की पार्टी के लिए चॉकलेट केक बनाया। उसने केक पर दस लाल मोमबत्तियां लगाईं।"),
            ExerciseItem(prompt: "रॉबर्ट का भाई कहाँ रहता है?", options: ["शिकागो", "न्यूयार्क", "बोस्टन", "मियामी"], correctAnswer: "शिकागो", explanation: "कहानी बताती है कि उसने शिकागो में अपने भाई को पार्सल भेजा था।", passage: "रॉबर्ट शिकागो में अपने भाई को एक पार्सल भेजने के लिए डाकघर गया। क्लर्क ने उसे बताया कि यह मंगलवार को पहुंचेगा।"),
            ExerciseItem(prompt: "सारा के नए दौड़ने वाले जूते किस रंग के हैं?", options: ["चमकीला हरा", "नीला", "लाल", "काला"], correctAnswer: "चमकीला हरा", explanation: "कहानी कहती है कि वे सफेद धारियों वाले चमकीले हरे रंग के हैं।", passage: "सारा ने कल दौड़ने वाले नए जूते खरीदे। वे सफ़ेद धारियों वाले चमकीले हरे रंग के हैं।"),
            ExerciseItem(prompt: "जेम्स ने किस रंग के छाते का उपयोग किया था?", options: ["पीला", "लाल", "नीला", "काला"], correctAnswer: "पीला", explanation: "कहानी कहती है कि उसने अपना पीला छाता खोला था।", passage: "जेम्स पार्क में टहल रहा था जब बारिश शुरू हो गई। सूखा रहने के लिए उसने अपना पीला छाता खोला।"),
            ExerciseItem(prompt: "बेकरी किस दिन बंद थी?", options: ["सोमवार", "मंगलवार", "बुधवार", "रविवार"], correctAnswer: "सोमवार", explanation: "कहानी कहती है कि बेकरी सोमवार को बंद थी।", passage: "स्थानीय बेकरी मरम्मत के लिए सोमवार को बंद थी। उन्होंने मंगलवार सुबह छह बजे फिर से खोलने की योजना बनाई।"),
            ExerciseItem(prompt: "अन्ना ने प्लंबर को क्यों बुलाया था?", options: ["उसका सिंक लीक हो रहा था", "उसका चूल्हा खराब था", "उसकी बत्ती गुल थी", "उसका दरवाज़ा बंद था"], correctAnswer: "उसका सिंक लीक हो रहा था", explanation: "कहानी कहती है कि उसने प्लंबर को बुलाया क्योंकि उसका रसोई का सिंक लीक हो रहा था।", passage: "अन्ना ने एक प्लंबर को बुलाया क्योंकि उसकी रसोई का सिंक लीक हो रहा था। प्लंबर एक घंटे में आया और पाइप ठीक कर दिया।"),
            ExerciseItem(prompt: "डेविड के कुत्ते का नाम क्या है?", options: ["मैक्स", "बडी", "चार्ली", "रॉकी"], correctAnswer: "मैक्स", explanation: "कहानी में डेविड के कुत्ते का नाम मैक्स बताया गया है।", passage: "डेविड ने अपने कुत्ते मैक्स को घुमाया। मैक्स ने एक गिलहरी देखी और उस पर ज़ोर से भौंका।"),
            ExerciseItem(prompt: "हेलेन के पास कौन सी सब्जी खत्म हो गई थी?", options: ["गाजर", "आलू", "प्याज", "अजवाइन"], correctAnswer: "गाजर", explanation: "कहानी बताती है कि उसे एहसास हुआ कि उसकी गाजर खत्म हो गई थी।", passage: "हेलेन रात के खाने के लिए सब्जियों का सूप बना रही थी। उसे एहसास हुआ कि उसकी गाजर खत्म हो गई हैं, इसलिए उसने आलू का इस्तेमाल किया।"),
            ExerciseItem(prompt: "पीटर के दोपहर के भोजन का खर्च कितना था?", options: ["पंद्रह डॉलर", "दस डॉलर", "बीस डॉलर", "बारह डॉलर"], correctAnswer: "पंद्रह डॉलर", explanation: "कहानी में कहा गया है कि कुल लागत पंद्रह डॉलर थी।", passage: "पीटर ने दोपहर के भोजन के लिए एक पेपरोनी पिज्जा और एक सोडा ऑर्डर किया। कुल खर्च पंद्रह डॉलर था।"),
            ExerciseItem(prompt: "एलिस द्वारा उधार ली गई किताब किस विषय पर थी?", options: ["बागवानी", "इतिहास", "खाना बनाना", "यात्रा"], correctAnswer: "बागवानी", explanation: "कहानी में कहा गया है कि उसने बागवानी के बारे में एक किताब उधार ली थी।", passage: "एलिस बागवानी के बारे में एक किताब उधार लेने पुस्तकालय गई। उसने इतिहास की एक डीवीडी भी उधार ली।"),
            ExerciseItem(prompt: "ट्रेन में देरी क्यों हुई थी?", options: ["पटरियों का रखरखाव", "भारी तूफ़ान", "बिजली कटौती", "कर्मचारी की अनुपस्थिति"], correctAnswer: "पटरियों का रखरखाव", explanation: "कहानी बताती है कि पटरियों के रखरखाव के कारण ट्रेन में देरी हुई थी।", passage: "जॉर्ज नौकरी के इंटरव्यू के लिए सुबह की ट्रेन से शहर गया। पटरियों के रखरखाव के कारण उसकी ट्रेन पंद्रह मिनट देरी से चल रही थी।"),
            ExerciseItem(prompt: "नैन्सी ने कौन सा फूल खरीदा?", options: ["गुलाबी कार्नेशन", "लाल गुलाब", "पीले ट्यूलिप", "सफेद लिली"], correctAnswer: "गुलाबी कार्नेशन", explanation: "कहानी में कहा गया है कि उसने गुलाबी कार्नेशन खरीदे।", passage: "नैन्सी लाल गुलाब खरीदने नर्सरी गई। वे बिक चुके थे, इसलिए उसने उनके स्थान पर गुलाबी कार्नेशन खरीदे।")
        ]
    )
