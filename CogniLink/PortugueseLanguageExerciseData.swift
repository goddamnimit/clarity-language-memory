...
struct PortugueseLanguageExerciseData {
    ...
    private static let categoryCrossOutEasy = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "CADEIRA, TABELA, MAÇÃ, CAMA", options: ["CADEIRA", "TABELA", "MAÇÃ", "CAMA"], correctAnswer: "MAÇÃ", explanation: "Fruta, não um móvel."),
            ...
            ExerciseItem(id: UUID(), prompt: "PLACA, TAÇA, COPA, CARRO", options: ["PLACA", "TAÇA", "COPA", "CARRO"], correctAnswer: "CARRO", explanation: "Veículo, não um recipiente."),
            ...
            ExerciseItem(id: UUID(), prompt: "VERMELHO, AZUL, TABELA, VERDE", options: ["VERMELHO", "AZUL", "TABELA", "VERDE"], correctAnswer: "TABELA", explanation: "Móvel, não uma cor."),
            ...
            ExerciseItem(id: UUID(), prompt: "PENNY, NÍQUEL, DIME, JAQUETA", options: ["PENNY", "NÍQUEL", "DIME", "JAQUETA"], correctAnswer: "JAQUETA", explanation: "Roupa, não uma moeda."),
            ...
            ExerciseItem(id: UUID(), prompt: "CADEIRA, TABELA, MESA, GOLFINHO", options: ["CADEIRA", "TABELA", "MESA", "GOLFINHO"], correctAnswer: "GOLFINHO", explanation: "Animal, não um móvel."),
            ExerciseItem(id: UUID(), prompt: "Robin, ÁGUIA, SALMÃO, PAPAGAIO", options: ["Robin", "ÁGUIA", "SALMÃO", "PAPAGAIO"], correctAnswer: "SALMÃO", explanation: "Peixe, não uma ave."),
    ...
    private static let categoryCrossOutHard = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "FÊMUR, TÍBIA, RAIO, CÓRNEA", options: ["FÊMUR", "TÍBIA", "RAIO", "CÓRNEA"], correctAnswer: "CÓRNEA", explanation: "Parte do olho, não um osso."),
            ...
            ExerciseItem(id: UUID(), prompt: "CARDIGAN, BLAZER, gola alta, ESTILETO", options: ["CARDIGAN", "BLAZER", "gola alta", "ESTILETO"], correctAnswer: "ESTILETO", explanation: "Calçado, não uma roupa de cima."),
            ...
            ExerciseItem(id: UUID(), prompt: "Célsio, FAHRENHEIT, KELVIN, DECIBEL", options: ["Célsio", "FAHRENHEIT", "KELVIN", "DECIBEL"], correctAnswer: "DECIBEL", explanation: "Unidade de som, não de temperatura."),
            ...
            ExerciseItem(id: UUID(), prompt: "SONETO, HAIKU, LIMERICA, PROSA", options: ["SONETO", "HAIKU", "LIMERICA", "PROSA"], correctAnswer: "PROSA", explanation: "Escrita não métrica, não uma forma poética."),
            ExerciseItem(id: UUID(), prompt: "SOPRANO, ALTO, TENOR, CONDUTOR", options: ["SOPRANO", "ALTO", "TENOR", "CONDUTOR"], correctAnswer: "CONDUTOR", explanation: "Lidera a orquestra, não um tipo de voz cantante."),
            ...
            ExerciseItem(id: UUID(), prompt: "ESTOCOLMO, OSLO, HELSINQUIA, BRUXELAS", options: ["ESTOCOLMO", "OSLO", "HELSINQUIA", "BRUXELAS"], correctAnswer: "BRUXELAS", explanation: "Capital da Bélgica, não da Escandinávia."),
    ...
    private static let sentenceCompletionEasy = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "Ele consertou o ___.", options: ["afundar", "ligação", "piscadela"], correctAnswer: "afundar", explanation: "Ele consertou o problema do afundamento."),
    ...
    private static let morphology = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "Preposição correta: 'O livro pertence ___ Maria.'", options: ["à", "o", "de", "com"], correctAnswer: "à", explanation: "'À' é a crase correta (a + à) antes de nome feminino."),
    ...
    private static let analogies = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "OLHO : VER :: OUVIDO : ___", options: ["Toque", "Ouça", "Cheiro", "Gosto"], correctAnswer: "Ouça", explanation: "O olho serve para ver, assim como o ouvido serve para ouvir."),
            ExerciseItem(id: UUID(), prompt: "CHEF : COZINHA :: MÉDICO : ___", options: ["Biblioteca", "Hospitais", "Escola", "Loja"], correctAnswer: "Hospitais", explanation: "O chef trabalha na cozinha, assim como o médico trabalha nos hospitais."),
            ...
            ExerciseItem(id: UUID(), prompt: "FELIZ : RIR :: TRISTE : ___", options: ["Sorria", "Dormir", "Chorar", "Corre"], correctAnswer: "Chorar", explanation: "Quando estamos felizes, rimos; quando estamos tristes, choramos."),
            ...
            ExerciseItem(id: UUID(), prompt: "LÁPIS : ESCREVER :: ESCOVA : ___", options: ["Cortar", "Pintar", "Varrer", "Mexa"], correctAnswer: "Pintar", explanation: "O lápis é usado para escrever, assim como a escova é usada para pintar."),
            ...
            ExerciseItem(id: UUID(), prompt: "PROFESSOR : ESCOLA :: JUIZ : ___", options: ["Escritório", "Hospitais", "Tribunal", "Loja"], correctAnswer: "Tribunal", explanation: "O professor trabalha na escola, assim como o juiz trabalha no tribunal."),
    ...
    private static let rhymingPairs = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "Escolha a palavra que rima com \"pé\":", options: ["café", "pão", "lua", "ruia"], correctAnswer: "café", explanation: "'Pé' e 'café' rimam porque ambos terminam com o som '-é'."),
    ...
    private static let wordAssociation = Exercise(
        ...
        difficulty: .easy,
        items: [
            ExerciseItem(id: UUID(), prompt: "MÉDICO", options: ["Hospitais", "Aeroporto", "Biblioteca", "Fazenda"], correctAnswer: "Hospitais", explanation: "Os médicos trabalham em hospitais para cuidar dos pacientes."),
            ...
            ExerciseItem(id: UUID(), prompt: "CHAVE", options: ["Bloquear", "Janela", "Telhado", "Piso"], correctAnswer: "Bloquear", explanation: "As chaves são usadas para abrir fechaduras."),
            ...
            ExerciseItem(id: UUID(), prompt: "ABELHA", options: ["Querida", "Leite", "Lã", "Seda"], correctAnswer: "Querida", explanation: "As abelhas produzem mel."),
    ...
    private static let completingProverbs = Exercise(
        ...
        difficulty: .medium,
        items: [
            ExerciseItem(id: UUID(), prompt: "Mais vale um pássaro na mão do que dois a ___", options: ["voar", "cantar", "comer", "correr"], correctAnswer: "voar", explanation: "É melhor ter algo garantido do que arriscar por mais."),
    ...
    private static let compoundWords = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "pernilongo + pernilongo = ___", options: ["pernilongo", "perna-longa", "mosquito", "borrachudo"], correctAnswer: "pernilongo", explanation: "Nome popular para os mosquitos de pernas longas que picam à noite."),
            ExerciseItem(id: UUID(), prompt: "planalto + planalto = ___", options: ["planalto", "planície", "montanha", "vale"], correctAnswer: "planalto", explanation: "Uma área geográfica plana situada em grande altitude.")
        ]
    )
    ...
    private static let prefixesSuffixes = Exercise(
        ...
        items: [
            ...
            ExerciseItem(id: UUID(), prompt: "O sufixo \"-dade\" forma substantivos abstratos de qualidade. Qual palavra usa esse sufixo?", options: ["bondade", "bondoso", "bom", "b bondade"], correctAnswer: "bondade", explanation: "'Bondade' usa '-dade' para indicar a qualidade de ser bom."),
